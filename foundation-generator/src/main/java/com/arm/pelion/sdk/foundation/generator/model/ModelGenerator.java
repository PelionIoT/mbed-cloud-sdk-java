    ...
    private static String generateFileComment(Model model) {
        ...
        if (model != null) {
            if (model.isAbstract()) {
                ...
                builder.append("This is an autogenerated abstract class. Do not modify its content.");
                builder.append(System.lineSeparator());
                ...
                if (model.containsCustomCode()) {
                    ...
                    builder.append("This is an autogenerated model class. Do not modify its content as modifications will be lost at next code generation.");
                }
            }
        }
