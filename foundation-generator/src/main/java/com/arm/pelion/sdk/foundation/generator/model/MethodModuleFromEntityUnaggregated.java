...
public class MethodModuleFromEntityUnaggregated extends MethodModuleCloudApiUnaggregated {

    public MethodModuleFromEntityUnaggregated(MethodModuleCloudApiUnaggregated methodBasedOn,
                                              List<Parameter> methodParameters, boolean enforceModelValidity) {
