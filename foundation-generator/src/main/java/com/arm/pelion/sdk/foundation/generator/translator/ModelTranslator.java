...
public class ModelTranslator {
    ...
    public static Model translate(Entity entity) throws FoundationGeneratorException {
        ...
        Model model = new Model(generatePackageName(entity.getGroupId()), entity.getKey(),
    ...
    private static String generatePackageName(List<String> groupId) {
        ...
        return "com.arm.mbed.cloud." + String.valueOf(specificPackage == null ? "" : specificPackage + ".") + "model";
    }
