...
public class MethodModuleModifyApi extends MethodModuleCloudApi {
    ...
    protected void translateParameter(String parameterName, String initialParameterName, TypeParameter type,
        ...
        if (type.isLowLevelModel()) {
            dealWithModifiedModel(this, isForCreation, parameterName, builder, callElements, unusedParameters);
        } else {
    ...
    public static void dealWithModifiedModel(MethodModuleCloudApi method, boolean isForCreation, String parameterName,
        ...
        if (!unusedParameters.isEmpty()) {
            method.addUnusedParametersToBodyParameter(unusedParameters, builder, callElements);
        }
    }
