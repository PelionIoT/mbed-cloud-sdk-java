...
public class DeviceListDao extends AbstractDeviceListDao {
  /**
   * Constructor.
   */
   ...
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.devices.model.Device#listDevices(Integer,String,String,String,String,DeviceListOptions)}
   * @param options list options.
   * @return one page of devices
   */
  @Override
  protected ListResponse<Device> requestOnePage(DeviceListOptions options) throws
      MbedCloudException, NotImplementedException {
    // TODO Auto-generated method stub.;
    throw new NotImplementedException();
    checkDaoConfiguration();
    return module.listDevices(null, null, null, null, null, options);
  }
}
