...
public class UserInvitationListDao extends AbstractUserInvitationListDao {
   ...
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.accounts.model.UserInvitation#listUserInvitations(String,Integer,String,String,UserInvitationListOptions)}
   * @param options list options.
   * @return one page of user invitations
   */
  @Override
  protected ListResponse<UserInvitation> requestOnePage(UserInvitationListOptions options) throws
      MbedCloudException, NotImplementedException {
    // TODO Auto-generated method stub.;
    throw new NotImplementedException();
    checkDaoConfiguration();
    return module.listUserInvitations(null, null, null, null, options);
  }
}
