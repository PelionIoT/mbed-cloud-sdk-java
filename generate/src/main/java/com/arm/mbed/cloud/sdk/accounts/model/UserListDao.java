...
public class UserListDao extends AbstractUserListDao {
   ...
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.accounts.model.User#listUsers(String,Integer,String,String,String,String,String,String,String,UserListOptions)}
  ...
  protected ListResponse<User> requestOnePage(UserListOptions options) throws MbedCloudException,
    ...
    return module.listUsers(null, null, null, null, null, null, null, null, null, options);
  }
}
