...
@Preamble(
    description = "Adapter for trusted certificates."
)
@Internal
public class TrustedCertificateAdapter {
  /**
   * Constructor.
   */
  protected TrustedCertificateAdapter() {
    super();
    // Nothing to do;
  }
  ...
  public static TrustedCertificate map(TrustedCertificateResp toBeMapped) {
    ...
    //No field equivalent to privateKey in TrustedCertificate was found in TrustedCertificateResp;
   ...
   * @param toBeMapped a trusted certificate.
  ...
  public static TrustedCertificateReq reverseMapAddRequest(TrustedCertificate toBeMapped) {
    ...
    trustedCertificateReq.setService(translateToComArmMbedCloudSdkInternalIamModelTrustedcertificatereqServiceenum(toBeMapped.getService()));
    //No field equivalent to signature in TrustedCertificateReq was found in TrustedCertificate;
    trustedCertificateReq.setStatus(translateToComArmMbedCloudSdkInternalIamModelTrustedcertificatereqStatusenum(toBeMapped.getStatus()));
  ...
  public static TrustedCertificateUpdateReq reverseMapUpdateRequest(TrustedCertificate toBeMapped) {
    ...
    trustedCertificateUpdateReq.setService(translateToComArmMbedCloudSdkInternalIamModelTrustedcertificateupdatereqServiceenum(toBeMapped.getService()));
    //No field equivalent to signature in TrustedCertificateUpdateReq was found in TrustedCertificate;
    trustedCertificateUpdateReq.setStatus(translateToComArmMbedCloudSdkInternalIamModelTrustedcertificateupdatereqStatusenum(toBeMapped.getStatus()));
   ...
   */
  @Internal
  protected static TrustedCertificateService translateToTrustedCertificateService(
   ...
   */
  @Internal
  protected static TrustedCertificateStatus translateToTrustedCertificateStatus(
  ...
  /**
   * Maps the enum value.
   * @param toBeMapped a trusted certificate service.
   * @return mapped enum value
   */
  @Internal
  protected static TrustedCertificateUpdateReq.ServiceEnum translateToComArmMbedCloudSdkInternalIamModelTrustedcertificateupdatereqServiceenum(
      TrustedCertificateService toBeMapped) {
    if(toBeMapped == null) {
      return null;
    }
    switch(toBeMapped) {
  ...
  /**
   * Maps the enum value.
   * @param toBeMapped a trusted certificate status.
   * @return mapped enum value
   */
  @Internal
  protected static TrustedCertificateUpdateReq.StatusEnum translateToComArmMbedCloudSdkInternalIamModelTrustedcertificateupdatereqStatusenum(
      TrustedCertificateStatus toBeMapped) {
    if(toBeMapped == null) {
      return null;
    }
    switch(toBeMapped) {
