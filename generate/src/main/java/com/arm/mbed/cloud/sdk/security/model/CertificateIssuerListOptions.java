...
@Preamble(
    description = "Options to use when listing certificate issuers."
)
public class CertificateIssuerListOptions extends ListOptions {
   ...
   * <p>
   * Note: Should not be used. Use {@link #CertificateIssuerListOptions()} instead.
   * @param certificateIssuerListOptions a certificate issuer list options.
   */
  @Internal
  ...
  public String toString() {
    return "CertificateIssuerListOptions [pageSize=" + pageSize
