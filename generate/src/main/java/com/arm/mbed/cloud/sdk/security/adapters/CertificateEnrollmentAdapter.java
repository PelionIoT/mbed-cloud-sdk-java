...
public class CertificateEnrollmentAdapter {
   ...
   * Constructor.
   */
  protected CertificateEnrollmentAdapter() {
    super();
    // Nothing to do;
  }
  ...
  public static CertificateEnrollment map(
      com.arm.mbed.cloud.sdk.internal.certificaterenewal.model.CertificateEnrollment toBeMapped) {
    if(toBeMapped == null) {
      return null;
    }
   ...
   */
  @Internal
  public static GenericAdapter.Mapper<com.arm.mbed.cloud.sdk.internal.certificaterenewal.model.CertificateEnrollment, CertificateEnrollment> getMapper(
      ) {
    return new GenericAdapter.Mapper<com.arm.mbed.cloud.sdk.internal.certificaterenewal.model.CertificateEnrollment, CertificateEnrollment>() {
      /**
       * Maps.
  ...
  public static ListResponse<CertificateEnrollment> mapList(
    ...
    final GenericAdapter.RespList<com.arm.mbed.cloud.sdk.internal.certificaterenewal.model.CertificateEnrollment> respList = new GenericAdapter.RespList<com.arm.mbed.cloud.sdk.internal.certificaterenewal.model.CertificateEnrollment>() {
      /**
       * @return something
       */
      @Override
  ...
  protected static CertificateEnrollmentEnrollResult translateToCertificateEnrollmentEnrollResult(
      com.arm.mbed.cloud.sdk.internal.certificaterenewal.model.CertificateEnrollment.EnrollResultEnum toBeMapped) {
    if(toBeMapped == null) {
  ...
  protected static CertificateEnrollmentEnrollStatus translateToCertificateEnrollmentEnrollStatus(
      com.arm.mbed.cloud.sdk.internal.certificaterenewal.model.CertificateEnrollment.EnrollStatusEnum toBeMapped) {
    if(toBeMapped == null) {
