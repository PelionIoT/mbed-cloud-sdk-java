...
@Preamble(
    description = "Data Access Object (DAO) for subtenant trusted certificates."
)
public abstract class AbstractSubtenantTrustedCertificateDao extends AbstractModelDao<SubtenantTrustedCertificate> implements CrudDao<SubtenantTrustedCertificate> {
  /**
   * Constructor.
   */
   ...
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.security.model.SubtenantTrustedCertificate#createSubtenantTrustedCertificate(SubtenantTrustedCertificate)}
   * @return something
   */
  @Override
   ...
   */
  @Override
  public SubtenantTrustedCertificate create(
   ...
   * Adds a subtenant trusted certificate.
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.security.model.SubtenantTrustedCertificate#createSubtenantTrustedCertificate(String,SubtenantTrustedCertificate)}
   ...
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.security.model.SubtenantTrustedCertificate#deleteSubtenantTrustedCertificate(SubtenantTrustedCertificate)}
   */
  @Override
   ...
   */
  @Override
  public void delete(@NonNull SubtenantTrustedCertificate subtenantTrustedCertificate) throws
      MbedCloudException {
    setModel(subtenantTrustedCertificate);
    delete();
  }
   ...
   * Deletes a subtenant trusted certificate.
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.security.model.SubtenantTrustedCertificate#deleteSubtenantTrustedCertificate(String,String)}
   ...
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.security.model.SubtenantTrustedCertificate#getSubtenantTrustedCertificate(SubtenantTrustedCertificate)}
   * @return something
   */
  @Override
   ...
   * Gets a subtenant trusted certificate.
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.security.model.SubtenantTrustedCertificate#getSubtenantTrustedCertificate(String,String)}
   * @param accountId The ID of the account.
   * @param id Entity ID.
   * @return something
   */
  public SubtenantTrustedCertificate get(@NonNull String accountId, @NonNull String id) throws
      MbedCloudException {
   ...
   * 
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.security.model.SubtenantTrustedCertificate#getDeveloperCertificateInfo(SubtenantTrustedCertificate)}
   * @return something
   */
   ...
   * 
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.security.model.SubtenantTrustedCertificate#getDeveloperCertificateInfo(String)}
   ...
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.security.model.SubtenantTrustedCertificate#updateSubtenantTrustedCertificate(SubtenantTrustedCertificate)}
   * @return something
   */
  @Override
   ...
   */
  @Override
  public SubtenantTrustedCertificate update(
      @NonNull SubtenantTrustedCertificate subtenantTrustedCertificate) throws MbedCloudException {
    setModel(subtenantTrustedCertificate);
    return update();
  }
   ...
   * Modifies a subtenant trusted certificate.
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.security.model.SubtenantTrustedCertificate#updateSubtenantTrustedCertificate(String,String,SubtenantTrustedCertificate)}
   * @param accountId The ID of the account.
   * @param id Entity ID.
   * @return an updated subtenant trusted certificate
   */
  public SubtenantTrustedCertificate update(@NonNull String accountId, @NonNull String id) throws
      MbedCloudException {
