...
// This model class was autogenerated on Thu Jan 31 01:11:06 GMT 2019. Feel free to change its contents as you wish.
...
public class UserDao extends AbstractUserDao {
     ...
     */
    @Override
    public User create(User modelToCreate) throws MbedCloudException {
        setModel(((Accounts) getModuleOrThrow()).createUser("create", modelToCreate));
        return getModel();
    }
}
