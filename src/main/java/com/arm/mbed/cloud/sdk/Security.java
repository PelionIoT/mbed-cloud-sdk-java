...
public class Security extends AbstractModule {
   ...
   * "client_certificate": "-----BEGIN CERTIFICATE-----MIIC7zCCAdegAwIBAgIJANTlU4x5S74VMA0GCSqGSIb3DQEBCwUAMA4xDDAKBgNVBAoMA0FybTAeFw0xODAzMTExMzE5MTFaFw0xOTAzMTExMzE5MTFaMA4xDDAKBgNVBAoMA0FybTCCASIwDQYJKo
   ...
   * PT9/jpo9b4+NsfFiAN6bMici81aIKZzLC+lLGOUmR2fFJyM5OsVLxKsko=-----END CERTIFICATE-----",
  ...
  public CertificateIssuer createCertificateIssuer(@Nullable Map<String, String> issuerCredentials,
    ...
    return CloudCaller.call(this, "createCertificateIssuer()",CertificateIssuerAdapter.getMapper(),new CloudRequest.CloudCall<CertificateIssuerInfo>() {
      ...
      public Call<CertificateIssuerInfo> call() {
        return endpoints.getCertificateIssuersApi().createCertificateIssuer(CertificateIssuerAdapter.reverseMapAddRequest(finalCertificateIssuerRequest).issuerCredentials(finalIssuerCredentials));
      }
    } );
  }
   ...
   * 
   * **Note:** The number of developer certificates allowed per account is limited. Please see [Using your own certificate authority](/docs/current/mbed-cloud-deploy/instructions-for-factory-setup-and-devi
   * ce-provision.html#using-your-own-certificate-authority-with-mbed-cloud).
   * 
   * **Example usage:**
   * curl -X POST "http://api.us-east-1.mbedcloud.com/v3/developer-certificates" -H "accept: application/json" -H "Authorization: Bearer THE_ACCESS_TOKEN" -H "content-type: application/json" -d "{ \"name\"
   ...
   * 
   * **Example usage:**
   * `curl -X POST https://api.us-east-1.mbedcloud.com/v3/accounts/{account_id}/trusted-certificates -d {"name": "myCert1", "description": "very important cert", "certificate": "certificate_data", "service
   * ": "lwm2m"} -H 'content-type: application/json' -H 'Authorization: Bearer API_KEY'`
   * 
  ...
  @API
  @Nullable
  public SubtenantTrustedCertificate createSubtenantTrustedCertificate(@NonNull String accountId,
  ...
  public SubtenantTrustedCertificate createSubtenantTrustedCertificate(
    ...
    checkNotNull(subtenantTrustedCertificate,TAG_SUBTENANT_TRUSTED_CERTIFICATE);
    checkModelValidity(subtenantTrustedCertificate,TAG_SUBTENANT_TRUSTED_CERTIFICATE);
    return  createSubtenantTrustedCertificate(subtenantTrustedCertificate.getAccountId(), subtenantTrustedCertificate);
  }
   ...
   * 
   * **Example usage:**
   * `curl -X POST https://api.us-east-1.mbedcloud.com/v3/trusted-certificates -d {"name": "myCert1", "description": "very important cert", "certificate": "certificate_data", "service": "lwm2m"} -H 'conten
   * t-type: application/json' -H 'Authorization: Bearer API_KEY'`
   * 
   ...
   */
  @API
  public void deleteSubtenantTrustedCertificate(@NonNull String accountId, @NonNull String id)
      throws MbedCloudException {
    checkNotNull(accountId,TAG_ACCOUNT_ID);
    checkNotNull(id,TAG_ID);
    final String finalAccountId = accountId;
   ...
   */
  @API
  public void deleteSubtenantTrustedCertificate(
      @NonNull SubtenantTrustedCertificate subtenantTrustedCertificate) throws MbedCloudException {
    checkNotNull(subtenantTrustedCertificate,TAG_SUBTENANT_TRUSTED_CERTIFICATE);
     deleteSubtenantTrustedCertificate(subtenantTrustedCertificate.getAccountId(), subtenantTrustedCertificate.getId());
  }
  ...
  public CertificateEnrollment getCertificateEnrollment(
    ...
    return  getCertificateEnrollment(certificateEnrollment.getId());
  }
  ...
  public CertificateEnrollment getCertificateEnrollment(@NonNull String id) throws
    ...
    checkNotNull(id,TAG_ID);
    final String finalId = id;
    return CloudCaller.call(this, "getCertificateEnrollment()",CertificateEnrollmentAdapter.getMapper(),new CloudRequest.CloudCall<com.arm.mbed.cloud.sdk.lowlevel.pelionclouddevicemanagement.model.CertificateEnrollment>() {
      /**
       * Makes the low level call to the Cloud.
       * @return Corresponding Retrofit2 Call object
       */
  ...
  public CertificateIssuer getCertificateIssuer(@NonNull CertificateIssuer certificateIssuer) throws
      MbedCloudException {
    checkNotNull(certificateIssuer,TAG_CERTIFICATE_ISSUER);
    return  getCertificateIssuer(certificateIssuer.getId());
  }
  ...
  public CertificateIssuerConfig getCertificateIssuerConfig(
      @NonNull CertificateIssuerConfig certificateIssuerConfig) throws MbedCloudException {
    checkNotNull(certificateIssuerConfig,TAG_CERTIFICATE_ISSUER_CONFIG);
    return  getCertificateIssuerConfig(certificateIssuerConfig.getId());
  }
  ...
  public CertificateIssuerConfig getDefault() throws MbedCloudException {
    return CloudCaller.call(this, "getDefault()",CertificateIssuerConfigAdapter.getMapper(),new CloudRequest.CloudCall<CertificateIssuerConfigResponse>() {
      /**
       * Makes the low level call to the Cloud.
       * @return Corresponding Retrofit2 Call object
       */
  ...
  public DeveloperCertificate getDeveloperCertificate(
      @NonNull DeveloperCertificate developerCertificate) throws MbedCloudException {
    checkNotNull(developerCertificate,TAG_DEVELOPER_CERTIFICATE);
    return  getDeveloperCertificate(developerCertificate.getId());
  }
  ...
  public DeveloperCertificate getDeveloperCertificateInfo(@NonNull String id) throws
    ...
    checkNotNull(id,TAG_ID);
    final String finalId = id;
    return CloudCaller.call(this, "getDeveloperCertificateInfo()",DeveloperCertificateAdapter.getMapper(),new CloudRequest.CloudCall<DeveloperCertificateResponseData>() {
      /**
       * Makes the low level call to the Cloud.
       * @return Corresponding Retrofit2 Call object
       */
  ...
  @API
  @Nullable
  public DeveloperCertificate getDeveloperCertificateInfo(
      @NonNull SubtenantTrustedCertificate subtenantTrustedCertificate) throws MbedCloudException {
    checkNotNull(subtenantTrustedCertificate,TAG_SUBTENANT_TRUSTED_CERTIFICATE);
  ...
  @API
  @Nullable
  public SubtenantTrustedCertificate getSubtenantTrustedCertificate(@NonNull String accountId,
      @NonNull String id) throws MbedCloudException {
    checkNotNull(accountId,TAG_ACCOUNT_ID);
    checkNotNull(id,TAG_ID);
    final String finalAccountId = accountId;
    final String finalId = id;
    return CloudCaller.call(this, "getSubtenantTrustedCertificate()",SubtenantTrustedCertificateAdapter.getMapper(),new CloudRequest.CloudCall<TrustedCertificateResp>() {
      /**
       * Makes the low level call to the Cloud.
       * @return Corresponding Retrofit2 Call object
       */
      @Override
      public Call<TrustedCertificateResp> call() {
        return endpoints.getAggregatorAccountAdminApi().getAccountCertificate(finalAccountId, finalId);
      }
    } );
  }
  ...
  @API
  @Nullable
  public SubtenantTrustedCertificate getSubtenantTrustedCertificate(
      @NonNull SubtenantTrustedCertificate subtenantTrustedCertificate) throws MbedCloudException {
    checkNotNull(subtenantTrustedCertificate,TAG_SUBTENANT_TRUSTED_CERTIFICATE);
    return  getSubtenantTrustedCertificate(subtenantTrustedCertificate.getAccountId(), subtenantTrustedCertificate.getId());
  }
  ...
  @API
  @Nullable
  public TrustedCertificate getTrustedCertificate(@NonNull String id) throws MbedCloudException {
    checkNotNull(id,TAG_ID);
    final String finalId = id;
  ...
  public TrustedCertificate getTrustedCertificate(@NonNull TrustedCertificate trustedCertificate)
      throws MbedCloudException {
    checkNotNull(trustedCertificate,TAG_TRUSTED_CERTIFICATE);
    return  getTrustedCertificate(trustedCertificate.getId());
  }
  ...
  @API
  @Nullable
  public TrustedCertificate getTrustedCertificateInfo(
      @NonNull DeveloperCertificate developerCertificate) throws MbedCloudException {
    checkNotNull(developerCertificate,TAG_DEVELOPER_CERTIFICATE);
  ...
  @API
  @Nullable
  public TrustedCertificate getTrustedCertificateInfo(@NonNull String id) throws
      MbedCloudException {
    checkNotNull(id,TAG_ID);
    final String finalId = id;
    return CloudCaller.call(this, "getTrustedCertificateInfo()",TrustedCertificateAdapter.getMapper(),new CloudRequest.CloudCall<TrustedCertificateResp>() {
      /**
       * Makes the low level call to the Cloud.
       * @return Corresponding Retrofit2 Call object
       */
  ...
  public Paginator<TrustedCertificate> listAllTrustedCertificates(@Nullable String nameEq,
    ...
    return new Paginator<TrustedCertificate>(finalOptions, new PageRequester<TrustedCertificate>() {
      ...
      public ListResponse<TrustedCertificate> requestNewPage(ListOptions options) throws
          MbedCloudException {
        return listTrustedCertificates(finalNameEq, finalServiceEq, finalExpireEq, finalDeviceExecutionModeEq, finalDeviceExecutionModeNeq, finalOwnerEq, finalEnrollmentModeEq, finalStatusEq, finalIssuerLike, finalSubjectLike, (TrustedCertificateListOptions) options);
      }
    });
  }
  ...
  public ListResponse<TrustedCertificate> listTrustedCertificates(@Nullable String nameEq,
    ...
    return CloudCaller.call(this, "listTrustedCertificates()",TrustedCertificateAdapter.getListMapper(),new CloudRequest.CloudCall<TrustedCertificateRespList>() {
      ...
      public Call<TrustedCertificateRespList> call() {
        return endpoints.getDeveloperApi().getAllCertificates(finalOptions.getPageSize(), finalOptions.getAfter(), finalOptions.getOrder().toString(), finalOptions.encodeInclude(), finalNameEq, finalServiceEq, finalExpireEq, finalDeviceExecutionModeEq, finalDeviceExecutionModeNeq, finalOwnerEq, finalEnrollmentModeEq, finalStatusEq, finalIssuerLike, finalSubjectLike);
      }
    } );
  }
  ...
  public CertificateIssuer updateCertificateIssuer(@Nullable Map<String, String> issuerCredentials,
    ...
    return CloudCaller.call(this, "updateCertificateIssuer()",CertificateIssuerAdapter.getMapper(),new CloudRequest.CloudCall<CertificateIssuerInfo>() {
      ...
      @Override
      public Call<CertificateIssuerInfo> call() {
        return endpoints.getCertificateIssuersApi().updateCertificateIssuer(finalId, CertificateIssuerAdapter.reverseMapUpdateRequest(finalCertificateIssuerUpdateRequest).issuerCredentials(finalIssuerCredentials));
      }
    } );
  }
  ...
  @Nullable
  public CertificateIssuerConfig updateCertificateIssuerConfig(
      @NonNull CertificateIssuerConfig certificateIssuerConfigRequest, @NonNull String id) throws
      MbedCloudException {
    ...
    return CloudCaller.call(this, "updateCertificateIssuerConfig()",CertificateIssuerConfigAdapter.getMapper(),new CloudRequest.CloudCall<CertificateIssuerConfigResponse>() {
      ...
      @Override
      public Call<CertificateIssuerConfigResponse> call() {
        return endpoints.getCertificateIssuersActivationApi().updateCertificateIssuerConfigByID(CertificateIssuerConfigAdapter.reverseMapUpdateRequest(finalCertificateIssuerConfigRequest), finalId);
      }
    } );
  }
   ...
   * 
   * **Example usage:**
   * `curl -X PUT https://api.us-east-1.mbedcloud.com/v3/accounts/{account_id}/trusted-certificates/{cert_id} -d {"description": "very important cert"} -H 'content-type: application/json' -H 'Authorization
   * : Bearer API_KEY'`
   * 
   * @param accountId The ID of the account.
   * @param id Entity ID.
  ...
  @API
  @Nullable
  public SubtenantTrustedCertificate updateSubtenantTrustedCertificate(@NonNull String accountId,
      @NonNull String id, @NonNull SubtenantTrustedCertificate subtenantTrustedCertificate) throws
      MbedCloudException {
    checkNotNull(accountId,TAG_ACCOUNT_ID);
    checkNotNull(id,TAG_ID);
    checkNotNull(subtenantTrustedCertificate,TAG_SUBTENANT_TRUSTED_CERTIFICATE);
    ...
    final String finalId = id;
    final SubtenantTrustedCertificate finalSubtenantTrustedCertificate = subtenantTrustedCertificate;
    return CloudCaller.call(this, "updateSubtenantTrustedCertificate()",SubtenantTrustedCertificateAdapter.getMapper(),new CloudRequest.CloudCall<TrustedCertificateResp>() {
      /**
       * Makes the low level call to the Cloud.
       * @return Corresponding Retrofit2 Call object
       */
      @Override
      public Call<TrustedCertificateResp> call() {
        return endpoints.getAggregatorAccountAdminApi().updateAccountCertificate(finalAccountId, finalId, SubtenantTrustedCertificateAdapter.reverseMapUpdateRequest(finalSubtenantTrustedCertificate));
      }
    } );
  }
  ...
  @API
  @Nullable
  public SubtenantTrustedCertificate updateSubtenantTrustedCertificate(
      @NonNull SubtenantTrustedCertificate subtenantTrustedCertificate) throws MbedCloudException {
    checkNotNull(subtenantTrustedCertificate,TAG_SUBTENANT_TRUSTED_CERTIFICATE);
    checkModelValidity(subtenantTrustedCertificate,TAG_SUBTENANT_TRUSTED_CERTIFICATE);
    return  updateSubtenantTrustedCertificate(subtenantTrustedCertificate.getAccountId(), subtenantTrustedCertificate.getId(), subtenantTrustedCertificate);
  }
  ...
  @API
  @Nullable
  public TrustedCertificate updateTrustedCertificate(@NonNull String id,
      @NonNull TrustedCertificate trustedCertificate) throws MbedCloudException {
    checkNotNull(id,TAG_ID);
    checkNotNull(trustedCertificate,TAG_TRUSTED_CERTIFICATE);
    checkModelValidity(trustedCertificate,TAG_TRUSTED_CERTIFICATE);
    ...
    return CloudCaller.call(this, "updateTrustedCertificate()",TrustedCertificateAdapter.getMapper(),new CloudRequest.CloudCall<TrustedCertificateResp>() {
      ...
      @Override
      public Call<TrustedCertificateResp> call() {
        return endpoints.getDeveloperApi().updateCertificate(finalId, TrustedCertificateAdapter.reverseMapUpdateRequest(finalTrustedCertificate));
      }
    } );
  }
  ...
  @API
  @Nullable
  public VerificationResponse verify(@NonNull CertificateIssuer certificateIssuer) throws
      MbedCloudException {
    checkNotNull(certificateIssuer,TAG_CERTIFICATE_ISSUER);
  ...
  public VerificationResponse verify(@NonNull String id) throws MbedCloudException {
    checkNotNull(id,TAG_ID);
    final String finalId = id;
    return CloudCaller.call(this, "verify()",VerificationResponseAdapter.getMapper(),new CloudRequest.CloudCall<CertificateIssuerVerifyResponse>() {
      /**
       * Makes the low level call to the Cloud.
       * @return Corresponding Retrofit2 Call object
       */
