...
@Preamble(
    description = "Options to use when listing subtenant trusted certificates."
)
public class SubtenantTrustedCertificateListOptions extends ListOptions {
   ...
   */
  @Internal
  public SubtenantTrustedCertificateListOptions(Integer pageSize, Long maxResults, Order order,
   ...
   * <p>
   * Note: Should not be used. Use {@link #SubtenantTrustedCertificateListOptions()} instead.
   * @param subtenantTrustedCertificateListOptions a subtenant trusted certificate list options.
   */
  @Internal
  public SubtenantTrustedCertificateListOptions(
      SubtenantTrustedCertificateListOptions subtenantTrustedCertificateListOptions) {
    this();
   ...
   */
  @Internal
  public SubtenantTrustedCertificateListOptions(String after, List<IncludeField> include,
      Filters filter) {
    this(0,
        0L,
        Order.getDefault(),
  ...
  public String toString() {
    return "SubtenantTrustedCertificateListOptions [pageSize=" + pageSize
