...
@Preamble(
    description = "Data Access Object (DAO) for subtenant users."
)
public abstract class AbstractSubtenantUserDao extends AbstractModelDao<SubtenantUser> implements CrudDao<SubtenantUser> {
  /**
   * Constructor.
   */
   ...
   * @return something
   */
  public SubtenantUser create(@Nullable @DefaultValue("create") String action) throws
      MbedCloudException {
   ...
   * Adds a subtenant user.
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.accounts.model.SubtenantUser#createSubtenantUser(String,String,SubtenantUser)}
   * @param action Create or invite user.
   ...
   * @return something
   */
  public SubtenantUser get(@NonNull String accountId, @NonNull String id) throws
      MbedCloudException {
   ...
   * Modifies a subtenant user.
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.accounts.model.SubtenantUser#updateSubtenantUser(String,String,SubtenantUser)}
   * @param accountId The ID of the account.
   * @param id The ID of the user.
   * @return an updated subtenant user
   */
  public SubtenantUser update(@NonNull String accountId, @NonNull String id) throws
      MbedCloudException {
   ...
   */
  public void validateEmail(@NonNull String accountId, @NonNull String id) throws
      MbedCloudException {
