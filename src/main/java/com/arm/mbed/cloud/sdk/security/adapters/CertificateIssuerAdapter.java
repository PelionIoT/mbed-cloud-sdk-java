...
public final class CertificateIssuerAdapter {
   ...
   * @param toBeMapped a certificate issuer info.
  ...
  /**
   * Maps the enum value.
   * @param toBeMapped an issuer type enum.
   * @return mapped enum value
   */
  @Internal
  protected static CertificateIssuerType translateToCertificateIssuerType(
      CertificateIssuerInfo.IssuerTypeEnum toBeMapped) {
    if(toBeMapped == null) {
  ...
  /**
   * Maps the enum value.
   * @param toBeMapped a certificate issuer type.
   * @return mapped enum value
   */
  @Internal
  protected static CertificateIssuerRequest.IssuerTypeEnum translateToComArmMbedCloudSdkLowlevelPelionclouddevicemanagementModelCertificateissuerrequestIssuertypeenum(
      CertificateIssuerType toBeMapped) {
    if(toBeMapped == null) {
      return null;
    }
    switch(toBeMapped) {
