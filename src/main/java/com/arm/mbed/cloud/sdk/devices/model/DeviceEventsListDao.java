...
public class DeviceEventsListDao extends AbstractModelListDao<DeviceEvents, DeviceEventsListOptions> implements ModelListDao<DeviceEvents, DeviceEventsListOptions> {
  /**
   * Constructor.
   */
  ...
  public DeviceEventsListDao clone() {
    try {
      return new DeviceEventsListDao().configureAndGet(getModuleOrThrow() == null? null: getModuleOrThrow().clone());
    }
