...
public class CertificateIssuerListDao extends AbstractModelListDao<CertificateIssuer, CertificateIssuerListOptions> implements ModelListDao<CertificateIssuer, CertificateIssuerListOptions> {
  /**
   * Constructor.
   */
  ...
  public CertificateIssuerListDao clone() {
    try {
      return new CertificateIssuerListDao().configureAndGet(getModuleOrThrow() == null? null: getModuleOrThrow().clone());
    }
   ...
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.security.model.CertificateIssuer#listCertificateIssuers(CertificateIssuerListOptions)}
