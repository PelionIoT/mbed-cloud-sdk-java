...
public class AccountListDao extends AbstractAccountListDao {
    ...
    protected ListResponse<Account> requestOnePage(AccountListOptions options) throws MbedCloudException,
        ...
        /*
         * checkDaoConfiguration(); return ((Accounts)module).listAccounts(null, null, null, null, null, null, null,
         * null, null, options);
         */
    }
    ...
    public AccountListDao clone() {
        try {
            return new AccountListDao().configureAndGet(getModule() == null ? null : getModule().clone());
