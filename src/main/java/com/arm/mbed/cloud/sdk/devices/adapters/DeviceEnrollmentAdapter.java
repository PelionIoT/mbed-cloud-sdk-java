...
@Preamble(
    description = "Adapter for device enrollments."
)
@Internal
...
public final class DeviceEnrollmentAdapter {
   ...
   * @param toBeMapped an enrollment identity.
  ...
  public static DeviceEnrollment map(EnrollmentIdentity toBeMapped) {
    ...
    final DeviceEnrollment deviceEnrollment = new DeviceEnrollment(toBeMapped.getAccountId(),TranslationUtils.toDate(toBeMapped.getClaimedAt()),TranslationUtils.toDate(toBeMapped.getCreatedAt()),toBeMapped.getEnrolledDeviceId(),TranslationUtils.toDate(toBeMapped.getExpiresAt()));
   ...
   * @param toBeMapped a device enrollment.
   ...
   * @param toBeMapped an enrollment identities.
