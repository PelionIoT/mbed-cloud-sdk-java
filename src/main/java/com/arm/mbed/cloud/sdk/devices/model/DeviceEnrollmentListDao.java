...
public class DeviceEnrollmentListDao extends AbstractModelListDao<DeviceEnrollment, DeviceEnrollmentListOptions> implements ModelListDao<DeviceEnrollment, DeviceEnrollmentListOptions> {
  /**
   * Constructor.
   */
  ...
  public DeviceEnrollmentListDao clone() {
    try {
      return new DeviceEnrollmentListDao().configureAndGet(getModuleOrThrow() == null? null: getModuleOrThrow().clone());
    }
   ...
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.devices.model.DeviceEnrollment#listDeviceEnrollments(DeviceEnrollmentListOptions)}
