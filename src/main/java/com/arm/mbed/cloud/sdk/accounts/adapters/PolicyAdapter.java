...
@Preamble(
    description = "Adapter for policies."
)
@Internal
...
public final class PolicyAdapter {
   ...
   * @param toBeMapped a feature policy.
  ...
  public static Policy map(FeaturePolicy toBeMapped) {
    ...
    final Policy policy = new Policy(toBeMapped.getAction(),TranslationUtils.toBool(toBeMapped.isAllow()),toBeMapped.getFeature(),TranslationUtils.toBool(toBeMapped.isInherited()),toBeMapped.getResource());
    return policy;
  }
