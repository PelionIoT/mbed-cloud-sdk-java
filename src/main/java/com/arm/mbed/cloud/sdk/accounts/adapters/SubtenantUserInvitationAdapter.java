...
@Preamble(
    description = "Adapter for subtenant user invitations."
)
@Internal
...
public final class SubtenantUserInvitationAdapter {
  ...
  public static SubtenantUserInvitation map(UserInvitationResp toBeMapped) {
    ...
    final SubtenantUserInvitation subtenantUserInvitation = new SubtenantUserInvitation(TranslationUtils.toDate(toBeMapped.getCreatedAt()),TranslationUtils.toDate(toBeMapped.getExpiration()),TranslationUtils.toDate(toBeMapped.getUpdatedAt()),toBeMapped.getUserId());
   ...
   * @param toBeMapped a subtenant user invitation.
