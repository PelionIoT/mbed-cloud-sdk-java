...
@Preamble(
    description = "Options to use when listing device events."
)
public class DeviceEventsListOptions extends ListOptions {
   ...
   * <p>
   * Note: Should not be used. Use {@link #DeviceEventsListOptions()} instead.
   * @param deviceEventsListOptions a device events list options.
   */
  @Internal
  ...
  public String toString() {
    return "DeviceEventsListOptions [pageSize=" + pageSize
