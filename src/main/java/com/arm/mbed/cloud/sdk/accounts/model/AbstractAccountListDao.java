...
public abstract class AbstractAccountListDao extends AbstractModelListDao<Account, AccountListOptions> implements ModelListDao<Account, AccountListOptions> {
  /**
   * Constructor.
   */
