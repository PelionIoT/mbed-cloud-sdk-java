...
@Preamble(
    description = "Adapter for subtenant users."
)
@Internal
...
public final class SubtenantUserAdapter {
  ...
  public static SubtenantUser map(UserInfoResp toBeMapped) {
    ...
    final SubtenantUser subtenantUser = new SubtenantUser(TranslationUtils.toDate(toBeMapped.getCreatedAt()),TranslationUtils.toLong(toBeMapped.getCreationTime()),TranslationUtils.toBool(toBeMapped.isEmailVerified()),TranslationUtils.toLong(toBeMapped.getLastLoginTime()),LoginHistoryAdapter.mapSimpleList(toBeMapped.getLoginHistory()),TranslationUtils.toLong(toBeMapped.getPasswordChangedTime()),TranslationUtils.toDate(toBeMapped.getUpdatedAt()));
   ...
   * @param toBeMapped a subtenant user.
   ...
   */
  @Internal
  protected static SubtenantUserStatus translateToSubtenantUserStatus(
      UserInfoResp.StatusEnum toBeMapped) {
    if(toBeMapped == null) {
  ...
  /**
   * Maps the enum value.
   * @param toBeMapped a subtenant user status.
   * @return mapped enum value
   */
  @Internal
  protected static UserUpdateReq.StatusEnum translateToComArmMbedCloudSdkLowlevelPelionclouddevicemanagementModelUserupdatereqStatusenum(
      SubtenantUserStatus toBeMapped) {
    if(toBeMapped == null) {
      return null;
    }
    switch(toBeMapped) {
