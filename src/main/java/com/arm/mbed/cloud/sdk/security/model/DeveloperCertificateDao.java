...
public class DeveloperCertificateDao extends AbstractModelDao<DeveloperCertificate> implements CreateDao<DeveloperCertificate>, DeleteDao<DeveloperCertificate>, ReadDao<DeveloperCertificate> {
  /**
   * Constructor.
   */
  ...
  public DeveloperCertificateDao clone() {
    try {
      return new DeveloperCertificateDao().configureAndGet(getModuleOrThrow() == null? null: getModuleOrThrow().clone());
    }
   ...
   */
  @Override
  public DeveloperCertificate create(@NonNull DeveloperCertificate developerCertificate) throws
      MbedCloudException {
   ...
   * 
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.security.model.DeveloperCertificate#getTrustedCertificateInfo(DeveloperCertificate)}
   * @return something
   */
