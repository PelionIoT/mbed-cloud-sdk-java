...
import com.arm.mbed.cloud.sdk.internal.model.ResourcePath;

@Preamble(description = "Adapter for presubscription model")
public class PresubscriptionAdapter {

    public static Presubscription map(com.arm.mbed.cloud.sdk.internal.model.Presubscription apiPresubscription) {
