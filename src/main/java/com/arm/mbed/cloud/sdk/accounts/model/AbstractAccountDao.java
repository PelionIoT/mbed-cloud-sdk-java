...
public abstract class AbstractAccountDao extends AbstractModelDao<Account> implements CreateDao<Account>, UpdateDao<Account>, ReadDao<Account> {
   ...
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.accounts.model.Account#allTrustedCertificates(String,String,Integer,Integer,Integer,String,Boolean,String,String,String,SubtenantTrustedCertificateListOptions,Account)}
   * @param nameEq null
   ...
   */
  public Paginator<SubtenantTrustedCertificate> allTrustedCertificates(@Nullable String nameEq,
    ...
    return ((Accounts)getModuleOrThrow()).allTrustedCertificates(nameEq, serviceEq, expireEq, deviceExecutionModeEq, deviceExecutionModeNeq, ownerEq, enrollmentModeEq, statusEq, issuerLike, subjectLike, options, getModel());
  }

  /**
   * Creates a {@link Paginator} for the list of subtenant trusted certificates matching filter options.
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.accounts.model.Account#allTrustedCertificates(String,String,String,Integer,Integer,Integer,String,Boolean,String,String,String,SubtenantTrustedCertificateListOptions)}
   * @param id Account ID.
   * @param nameEq null
   * @param serviceEq null
   * @param expireEq null
   ...
   * @return paginator over the list of subtenant trusted certificates
   */
  public Paginator<SubtenantTrustedCertificate> allTrustedCertificates(@NonNull String id,
      @Nullable String nameEq, @Nullable String serviceEq, @Nullable Integer expireEq,
      @Nullable Integer deviceExecutionModeEq, @Nullable Integer deviceExecutionModeNeq,
      @Nullable String ownerEq, @Nullable Boolean enrollmentModeEq, @Nullable String statusEq,
      @Nullable String issuerLike, @Nullable String subjectLike,
      @Nullable SubtenantTrustedCertificateListOptions options) throws MbedCloudException {
    return ((Accounts)getModuleOrThrow()).allTrustedCertificates(id, nameEq, serviceEq, expireEq, deviceExecutionModeEq, deviceExecutionModeNeq, ownerEq, enrollmentModeEq, statusEq, issuerLike, subjectLike, options);
  }

  /**
   * Creates a {@link Paginator} for the list of subtenant user invitations matching filter options.
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.accounts.model.Account#allUserInvitations(String,String,SubtenantUserInvitationListOptions)}
   * @param id Account ID.
   * @param loginProfileEq null
   * @param options list options.
   * @return paginator over the list of subtenant user invitations
   */
  public Paginator<SubtenantUserInvitation> allUserInvitations(@NonNull String id,
      @Nullable String loginProfileEq, @Nullable SubtenantUserInvitationListOptions options) throws
      MbedCloudException {
   ...
   * Creates a {@link Paginator} for the list of subtenant user invitations matching filter options.
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.accounts.model.Account#allUserInvitations(String,SubtenantUserInvitationListOptions,Account)}
   * @param loginProfileEq null
   * @param options list options.
   * @return paginator over the list of subtenant user invitations
   */
   ...
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.accounts.model.Account#allUsers(String,String,String,String,String,String,SubtenantUserListOptions)}
   * @param id Account ID.
   * @param emailEq null
   * @param statusEq null
   * @param statusIn null
   * @param statusNin null
   * @param loginProfileEq null
   * @param options list options.
  ...
  public Paginator<SubtenantUser> allUsers(@NonNull String id, @Nullable String emailEq,
      ...
      @Nullable String loginProfileEq, @Nullable SubtenantUserListOptions options) throws
      MbedCloudException {
    return ((Accounts)getModuleOrThrow()).allUsers(id, emailEq, statusEq, statusIn, statusNin, loginProfileEq, options);
  }

  /**
   * Creates a {@link Paginator} for the list of subtenant users matching filter options.
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.accounts.model.Account#allUsers(String,String,String,String,String,SubtenantUserListOptions,Account)}
   * @param emailEq null
   * @param statusEq null
   * @param statusIn null
   * @param statusNin null
  ...
  public Paginator<SubtenantUser> allUsers(@Nullable String emailEq, @Nullable String statusEq,
      @Nullable String statusIn, @Nullable String statusNin, @Nullable String loginProfileEq,
      @Nullable SubtenantUserListOptions options) throws MbedCloudException {
    return ((Accounts)getModuleOrThrow()).allUsers(emailEq, statusEq, statusIn, statusNin, loginProfileEq, options, getModel());
  }
   ...
   * @return something
   */
  public Account get(@Nullable String include, @Nullable String properties) throws
      MbedCloudException {
   ...
   * @return something
   */
  public Account get(@Nullable String include, @Nullable String properties, @NonNull String id)
  ...
  public Account me(@Nullable String include, @Nullable String properties) throws
      MbedCloudException {
   ...
   * 
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.accounts.model.Account#trustedCertificates(String,String,Integer,Integer,Integer,String,Boolean,String,String,String,SubtenantTrustedCertificateListOptions,Account)}
   * @param nameEq null
   * @param serviceEq null
   * @param expireEq null
   * @param deviceExecutionModeEq null
   ...
   */
  public ListResponse<SubtenantTrustedCertificate> trustedCertificates(@Nullable String nameEq,
      @Nullable String serviceEq, @Nullable Integer expireEq,
      @Nullable Integer deviceExecutionModeEq, @Nullable Integer deviceExecutionModeNeq,
      @Nullable String ownerEq, @Nullable Boolean enrollmentModeEq, @Nullable String statusEq,
      @Nullable String issuerLike, @Nullable String subjectLike,
      @Nullable SubtenantTrustedCertificateListOptions options) throws MbedCloudException {
    return ((Accounts)getModuleOrThrow()).trustedCertificates(nameEq, serviceEq, expireEq, deviceExecutionModeEq, deviceExecutionModeNeq, ownerEq, enrollmentModeEq, statusEq, issuerLike, subjectLike, options, getModel());
  }
   ...
   * 
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.accounts.model.Account#trustedCertificates(String,String,String,Integer,Integer,Integer,String,Boolean,String,String,String,SubtenantTrustedCertificateListOptions)}
   * @param id Account ID.
   * @param nameEq null
   * @param serviceEq null
   * @param expireEq null
   ...
   * @return the list of subtenant trusted certificates corresponding to filter options (One page).
   */
  public ListResponse<SubtenantTrustedCertificate> trustedCertificates(@NonNull String id,
      @Nullable String nameEq, @Nullable String serviceEq, @Nullable Integer expireEq,
      @Nullable Integer deviceExecutionModeEq, @Nullable Integer deviceExecutionModeNeq,
      @Nullable String ownerEq, @Nullable Boolean enrollmentModeEq, @Nullable String statusEq,
      @Nullable String issuerLike, @Nullable String subjectLike,
      @Nullable SubtenantTrustedCertificateListOptions options) throws MbedCloudException {
    return ((Accounts)getModuleOrThrow()).trustedCertificates(id, nameEq, serviceEq, expireEq, deviceExecutionModeEq, deviceExecutionModeNeq, ownerEq, enrollmentModeEq, statusEq, issuerLike, subjectLike, options);
  }
   ...
   * 
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.accounts.model.Account#userInvitations(String,String,SubtenantUserInvitationListOptions)}
   * @param id Account ID.
   * @param loginProfileEq null
   * @param options list options.
   * @return the list of subtenant user invitations corresponding to filter options (One page).
   */
  public ListResponse<SubtenantUserInvitation> userInvitations(@NonNull String id,
      @Nullable String loginProfileEq, @Nullable SubtenantUserInvitationListOptions options) throws
      MbedCloudException {
   ...
   * 
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.accounts.model.Account#userInvitations(String,SubtenantUserInvitationListOptions,Account)}
   * @param loginProfileEq null
   * @param options list options.
   * @return the list of subtenant user invitations corresponding to filter options (One page).
   */
   ...
   * 
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.accounts.model.Account#users(String,String,String,String,String,String,SubtenantUserListOptions)}
   * @param id Account ID.
   * @param emailEq null
   * @param statusEq null
   * @param statusIn null
  ...
  public ListResponse<SubtenantUser> users(@NonNull String id, @Nullable String emailEq,
      ...
      @Nullable String loginProfileEq, @Nullable SubtenantUserListOptions options) throws
      MbedCloudException {
    return ((Accounts)getModuleOrThrow()).users(id, emailEq, statusEq, statusIn, statusNin, loginProfileEq, options);
  }
   ...
   * 
   * <p>
   * Similar to {@link com.arm.mbed.cloud.sdk.accounts.model.Account#users(String,String,String,String,String,SubtenantUserListOptions,Account)}
   * @param emailEq null
   * @param statusEq null
   * @param statusIn null
   * @param statusNin null
  ...
  public ListResponse<SubtenantUser> users(@Nullable String emailEq, @Nullable String statusEq,
      @Nullable String statusIn, @Nullable String statusNin, @Nullable String loginProfileEq,
      @Nullable SubtenantUserListOptions options) throws MbedCloudException {
    return ((Accounts)getModuleOrThrow()).users(emailEq, statusEq, statusIn, statusNin, loginProfileEq, options, getModel());
  }
}
