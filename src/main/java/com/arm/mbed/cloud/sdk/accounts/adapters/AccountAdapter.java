...
public final class AccountAdapter {
   ...
   * @param toBeMapped an account info.
  ...
  public static Account map(AccountInfo toBeMapped) {
    ...
    final Account account = new Account(toBeMapped.getAdminId(),toBeMapped.getAdminKey(),TranslationUtils.toDate(toBeMapped.getCreatedAt()),TranslationUtils.toDate(toBeMapped.getExpiration()),toBeMapped.getLimits(),ParentAccountAdapter.map(toBeMapped.getParentAccount()),toBeMapped.getParentId(),PolicyAdapter.mapSimpleList(toBeMapped.getPolicies()),toBeMapped.getReason(),toBeMapped.getReferenceNote(),translateToAccountStatus(toBeMapped.getStatus()),toBeMapped.getTemplateId(),toBeMapped.getTier(),TranslationUtils.toDate(toBeMapped.getUpdatedAt()),TranslationUtils.toDate(toBeMapped.getUpgradedAt()));
  ...
  /**
   * Maps the enum value.
   * @param toBeMapped a mfa status enum.
   * @return mapped enum value
   */
  @Internal
  protected static AccountMfaStatus translateToAccountMfaStatus(
      AccountInfo.MfaStatusEnum toBeMapped) {
    if(toBeMapped == null) {
   ...
   */
  @Internal
  protected static AccountUpdateRootReq.MfaStatusEnum translateToComArmMbedCloudSdkLowlevelPelionclouddevicemanagementModelAccountupdaterootreqMfastatusenum(
