...
public final class TrustedCertificateAdapter {
  ...
  public static TrustedCertificate map(TrustedCertificateResp toBeMapped) {
    ...
    final TrustedCertificate trustedCertificate = new TrustedCertificate(toBeMapped.getAccountId(),toBeMapped.getCertificateFingerprint(),TranslationUtils.toDate(toBeMapped.getCreatedAt()),toBeMapped.getIssuer(),toBeMapped.getOwnerId(),toBeMapped.getSubject(),TranslationUtils.toDate(toBeMapped.getUpdatedAt()),TranslationUtils.toDate(toBeMapped.getValidity()));
