...
@Preamble(
    description = "Model for a parent account."
)
public class ParentAccount implements SdkModel {
   ...
   * @param adminEmail The email address of the admin user who is the contact person of the parent account.
   * @param adminName The name of the admin user who is the contact person of the parent account.
   ...
   * <p>
   * Note: Should not be used. Use {@link #ParentAccount()} instead.
   * @param parentAccount a parent account.
   */
  @Internal
   ...
   * @param parentAccountId The ID of the parent account.
   */
  @Internal
  ...
  public String toString() {
    return "ParentAccount [adminEmail=" + adminEmail
        + ", adminName=" + adminName
        + ", id=" + id + "]";
  }
