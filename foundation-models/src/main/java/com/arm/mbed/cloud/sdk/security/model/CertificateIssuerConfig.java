...
public class CertificateIssuerConfig implements SdkModel {
   ...
   * Null if Device Management internal HSM is used.
   * 
   * @param certificateReference The certificate name to which the certificate issuer configuration applies.
  ...
  public CertificateIssuerConfig(String certificateIssuerId, String certificateReference,
      Date createdAt, String id, Date updatedAt) {
    super();
  ...
  public boolean isValid() {
    return isCertificateIssuerIdValid()
        && isCertificateReferenceValid();
  }
