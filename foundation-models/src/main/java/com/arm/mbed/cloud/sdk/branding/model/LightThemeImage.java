...
public class LightThemeImage implements SdkModel {
    /**
     * Serialisation Id.
     */
     ...
     */
    @Required
    private LightThemeImageReference reference;
     ...
     *            Name of the image.
     */
    public LightThemeImage(LightThemeImageReference reference) {
     ...
     *
     * <p>
     * Warning: LightThemeImage model does not have any ID field. This always returns {@code null}.
     * 
     * @return id
     */
    @Override
