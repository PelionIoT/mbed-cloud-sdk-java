...
public class SubtenantTrustedCertificate implements SdkModel {
  ...
  @Internal
  @SuppressWarnings("PMD.CyclomaticComplexity")
  public SubtenantTrustedCertificate(String accountId, String certificate,
      String certificateFingerprint, Date createdAt, String description, int deviceExecutionMode,
      boolean enrollmentMode, String id, boolean isDeveloperCertificate, String issuer, String name,
      String ownerId, SubtenantTrustedCertificateService service,
      SubtenantTrustedCertificateStatus status, String subject, Date updatedAt, Date validity) {
    super();
  ...
  public SubtenantTrustedCertificate(SubtenantTrustedCertificate subtenantTrustedCertificate) {
    this(subtenantTrustedCertificate == null ? (String) null : subtenantTrustedCertificate.accountId,
        ...
        subtenantTrustedCertificate == null ? SubtenantTrustedCertificateService.getDefault() : subtenantTrustedCertificate.service,
        subtenantTrustedCertificate == null ? SubtenantTrustedCertificateStatus.getDefault() : subtenantTrustedCertificate.status,
  ...
  public String toString() {
    return "SubtenantTrustedCertificate [accountId=" + accountId
