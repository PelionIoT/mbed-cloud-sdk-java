...
@Preamble(
    description = "Model for a server credentials."
)
public class ServerCredentials implements SdkModel {
   ...
   * @param serverCertificate PEM format X.509 server certificate that will be used to validate the server certificate that will be received during the TLS/DTLS handshake.
   * @param serverUri Server URI to which the client needs to connect to.
   */
  @Internal
   ...
   * <p>
   * Note: Should not be used. Use {@link #ServerCredentials()} instead.
   * @param serverCredentials a server credentials.
   */
  @Internal
   ...
   * @param serverCredentialsId mUUID that uniquely identifies the entity.
   */
  @Internal
  ...
  /**
   * Sets pem format x.509 server certificate that will be used to validate the server certificate that will be received during the tls/dtls handshake.
   * @param serverCertificate PEM format X.509 server certificate that will be used to validate the server certificate that will be received during the TLS/DTLS handshake.
   */
  ...
  public String toString() {
    return "ServerCredentials [createdAt=" + createdAt
        + ", id=" + id
