...
public abstract class AbstractTrustedCertificate implements SdkModel {
  ...
  @Internal
  @SuppressWarnings("PMD.CyclomaticComplexity")
  public AbstractTrustedCertificate(String accountId, String certificate,
   ...
   * <p>
   * Note: Should not be used. Use {@link #AbstractTrustedCertificate()} instead.
   * @param abstractTrustedCertificate an abstract trusted certificate.
   */
  @Internal
  public AbstractTrustedCertificate(AbstractTrustedCertificate abstractTrustedCertificate) {
    this(abstractTrustedCertificate == null ? (String) null : abstractTrustedCertificate.accountId,
        ...
        abstractTrustedCertificate == null ? TrustedCertificateService.getDefault() : abstractTrustedCertificate.service,
        abstractTrustedCertificate == null ? TrustedCertificateStatus.getDefault() : abstractTrustedCertificate.status,
   ...
   * @param service Service name where the certificate is to be used.
   */
  public AbstractTrustedCertificate(String certificate, String name,
  ...
  public String toString() {
    return "AbstractTrustedCertificate [accountId=" + accountId
