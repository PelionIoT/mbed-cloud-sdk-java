...
/**
 * Subtenant dark theme image reference.
 */
@Preamble(description = "Subtenant dark theme image reference.")
public enum SubtenantDarkThemeImageReference implements SdkEnum {
     ...
     * Serialisation Id.
     */
    private static final long serialVersionUID = -297335076192122L;
     ...
     */
    @Internal
    SubtenantDarkThemeImageReference(@DefaultValue("APP_LOGO_LANDSCAPE") String string) {
        this.string = string;
    }
    ...
    /**
     * Gets default subtenant dark theme image reference.
     * 
     * @return default subtenant dark theme image reference
     */
    public static SubtenantDarkThemeImageReference getDefault() {
        return APP_LOGO_LANDSCAPE;
    }

    /**
     * Gets unknown subtenant dark theme image reference value.
     * 
     * @return unknown subtenant dark theme image reference
     */
    public static SubtenantDarkThemeImageReference getUnknownEnum() {
        return UNKNOWN_ENUM;
    }

    /**
     * Gets subtenant dark theme image reference from its string representation.
     * 
     * @param value
     *            string.
     * @return corresponding subtenant dark theme image reference or default subtenant dark theme image reference if not
     *         recognised.
     */
    public static SubtenantDarkThemeImageReference getValue(String value) {
        if (value == null) {
            return getDefault();
        }
        final String trimmedValue = value.trim();
        for (final SubtenantDarkThemeImageReference option : values()) {
     ...
     *            type of an sdk enum
     * @param obj1
     *            a subtenant dark theme image reference.
     * @param obj2
     *            a subtenant dark theme image reference.
