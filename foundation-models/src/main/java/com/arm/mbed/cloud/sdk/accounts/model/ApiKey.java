...
public class ApiKey implements SdkModel {
   ...
   */
  @Internal
  public ApiKey(String accountId, Date createdAt, long creationTime, String id, String key,
  ...
  public ApiKey(ApiKey apiKey) {
    this(apiKey == null ? (String) null : apiKey.accountId,
        apiKey == null ? new java.util.Date() : apiKey.createdAt,
   ...
   */
  @Internal
  public ApiKey(String accountId, Date createdAt, long creationTime, String key, long lastLoginTime,
      Date updatedAt) {
    this(accountId,
        createdAt,
        creationTime,
