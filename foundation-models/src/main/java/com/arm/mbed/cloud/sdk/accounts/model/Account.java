...
public class Account implements SdkModel {
   ...
   * @param adminEmail The email address of the account admin, not longer than 254 characters.
   * @param adminFullName The full name of the admin user to be created.
   * @param adminId The ID of the admin user created.
   * @param adminKey The admin API key created for the account.
   * @param adminName The username of the admin user to be created, containing alphanumerical letters and -,._@+= characters. It must be at least 4 but not more than 30 character long.
   * @param adminPassword The password when creating a new user. It will be generated when not present in the request.
   ...
   * @param subAccounts List of sub accounts. Not available for developer users.
  ...
  public Account(String addressLine1, String addressLine2, String adminEmail, String adminFullName,
      ...
      Date createdAt, long creationTime, Map<String, String> customFields, String customerNumber,
      String displayName, String email, String endMarket, String expirationWarningThreshold,
      List<String> groups, String id, String idleTimeout, String key, long lastLoginTime,
      Map<String, String> limits, AccountMfaStatus mfaStatus, String name,
      List<String> notificationEmails, String owner, String parentId, PasswordPolicy passwordPolicy,
      String phoneNumber, List<Policy> policies, String postalCode, String reason,
      String referenceNote, String salesContact, String state, AccountStatus status,
      List subAccounts, String templateId, String tier, Date updatedAt, Date upgradedAt) {
    super();
  ...
  public Account(Account account) {
    this(account == null ? (String) null : account.addressLine1,
        ...
        account == null ? 0L : account.creationTime,
        ...
        account == null ? null : account.subAccounts,
  ...
  /**
   * Gets the username of the admin user to be created, containing alphanumerical letters and -,._@+= characters. it must be at least 4 but not more than 30 character long.
   * @return adminName
   */
  ...
  /**
   * Sets the username of the admin user to be created, containing alphanumerical letters and -,._@+= characters. it must be at least 4 but not more than 30 character long.
   * @param adminName The username of the admin user to be created, containing alphanumerical letters and -,._@+= characters. It must be at least 4 but not more than 30 character long.
   */
  ...
  /**
   * Sets the tier level of the account; '0': free tier, '1': commercial account, '2': partner tier. other values are reserved for the future.
   * @param tier The tier level of the account; '0': free tier, '1': commercial account, '2': partner tier. Other values are reserved for the future.
   */
