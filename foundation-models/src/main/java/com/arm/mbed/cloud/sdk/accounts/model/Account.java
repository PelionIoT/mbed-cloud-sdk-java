...
@Preamble(
    description = "Model for an account."
)
...
public class Account implements SdkModel {
   ...
   * @param addressLine1 Postal address line 1.
   * @param addressLine2 Postal address line 2.
   * @param adminEmail The email address of the admin user created for this account. Present only in the response for the account creation.
   * @param adminFullName The full name of the admin user created for this account. Present only in the response for the account creation.
   * @param adminId The ID of the admin user created for this account.
   * @param adminKey The admin API key created for this account. Present only in the response for the account creation.
   * @param adminName The username of the admin user created for this account. Present only in the response for the account creation.
   * @param adminPassword The password of the admin user created for this account. Present only in the response for the account creation.
   ...
   * @param contractNumber Contract number of the customer.
   * @param country The country part of the postal address.
   * @param createdAt Creation UTC time RFC3339.
   * @param customFields Account's custom properties as key-value pairs.
   ...
   * @param endMarket Account end market.
   * @param expiration Expiration time of the account, as UTC time RFC3339.
   * @param expirationWarningThreshold Indicates how many days (1-180) before account expiration a notification email should be sent.
   * @param id Account ID.
   * @param idleTimeout The reference token expiration time in minutes for this account.
   * @param limits List of limits as key-value pairs if requested.
   * @param mfaStatus The enforcement status of the multi-factor authentication, either 'enforced' or 'optional'.
   * @param notificationEmails A list of notification email addresses.
   * @param parentAccount This object represents parent account contact details in responses.
   * @param parentId The ID of the parent account, if it has any.
   * @param passwordPolicy value.
   * @param phoneNumber The phone number of a representative of the company.
   * @param policies List of policies if requested.
   * @param postalCode The postal code part of the postal address.
   * @param reason A reason note for updating the status of the account.
   * @param referenceNote A reference note for updating the status of the account.
   * @param salesContact Email address of the sales contact.
   * @param state The state part of the postal address.
   * @param status The status of the account.
   * @param templateId Account template ID.
   * @param tier The tier level of the account; '0': free tier, '1': commercial account, '2': partner tier. Other values are reserved for the future.
   * @param updatedAt Last update UTC time RFC3339.
   * @param upgradedAt Time when upgraded to commercial account in UTC format RFC3339.
   */
  @Internal
  @SuppressWarnings("PMD.CyclomaticComplexity")
  public Account(String addressLine1, String addressLine2, String adminEmail, String adminFullName,
      String adminId, String adminKey, String adminName, String adminPassword, List<String> aliases,
      String city, String company, String contact, String contractNumber, String country,
      Date createdAt, Map<String, String> customFields, String customerNumber, String displayName,
      String email, String endMarket, Date expiration, String expirationWarningThreshold, String id,
      String idleTimeout, Map<String, String> limits, AccountMfaStatus mfaStatus,
      List<String> notificationEmails, ParentAccount parentAccount, String parentId,
      PasswordPolicy passwordPolicy, String phoneNumber, List<Policy> policies, String postalCode,
  ...
  public Account(Account account) {
    this(account == null ? (String) null : account.addressLine1,
        ...
        account == null ? (String) null : account.adminFullName,
        account == null ? (String) null : account.adminId,
        account == null ? (String) null : account.adminKey,
        account == null ? (String) null : account.adminName,
        account == null ? (String) null : account.adminPassword,
        account == null ? null : account.aliases,
        account == null ? (String) null : account.city,
        account == null ? (String) null : account.company,
        ...
        account == null ? null : account.customFields,
        account == null ? (String) null : account.customerNumber,
        account == null ? (String) null : account.displayName,
        account == null ? (String) null : account.email,
        ...
        account == null ? (String) null : account.id,
        account == null ? (String) null : account.idleTimeout,
        ...
        account == null ? null : account.policies,
        account == null ? (String) null : account.postalCode,
        account == null ? (String) null : account.reason,
        account == null ? (String) null : account.referenceNote,
        account == null ? (String) null : account.salesContact,
        account == null ? (String) null : account.state,
        account == null ? AccountStatus.getDefault() : account.status,
        account == null ? (String) null : account.templateId,
        account == null ? (String) null : account.tier,
  ...
  @Internal
  @SuppressWarnings("PMD.CyclomaticComplexity")
  public Account(String adminId, String adminKey, Date createdAt, Date expiration,
      Map<String, String> limits, ParentAccount parentAccount, String parentId,
      List<Policy> policies, String reason, String referenceNote, AccountStatus status,
      String templateId, String tier, Date updatedAt, Date upgradedAt) {
    this((String) null,
        (String) null,
        (String) null,
  ...
  /**
   * Gets the email address of the admin user created for this account. present only in the response for the account creation.
   * @return adminEmail
   */
  ...
  /**
   * Sets the email address of the admin user created for this account. present only in the response for the account creation.
   * @param adminEmail The email address of the admin user created for this account. Present only in the response for the account creation.
   */
  ...
  /**
   * Gets the full name of the admin user created for this account. present only in the response for the account creation.
  ...
  /**
   * Sets the full name of the admin user created for this account. present only in the response for the account creation.
   * @param adminFullName The full name of the admin user created for this account. Present only in the response for the account creation.
   */
  ...
  /**
   * Gets the username of the admin user created for this account. present only in the response for the account creation.
   * @return adminName
   */
  ...
  /**
   * Sets the username of the admin user created for this account. present only in the response for the account creation.
   * @param adminName The username of the admin user created for this account. Present only in the response for the account creation.
   */
  ...
  /**
   * Gets the password of the admin user created for this account. present only in the response for the account creation.
  ...
  /**
   * Sets the password of the admin user created for this account. present only in the response for the account creation.
   * @param adminPassword The password of the admin user created for this account. Present only in the response for the account creation.
   */
  ...
  /**
   * Gets the tier level of the account; '0': free tier, '1': commercial account, '2': partner tier. other values are reserved for the future.
   * @return tier
   */
  ...
  public String toString() {
    return "Account [addressLine1=" + addressLine1
