...
/**
 * Subtenant dark theme color reference.
 */
@Preamble(description = "Subtenant dark theme color reference.")
public enum SubtenantDarkThemeColorReference implements SdkEnum {
     ...
     * Serialisation Id.
     */
    private static final long serialVersionUID = -476263980192122L;
     ...
     */
    @Internal
    SubtenantDarkThemeColorReference(@DefaultValue("CANVAS_BACKGROUND") String string) {
        this.string = string;
    }
    ...
    /**
     * Gets default subtenant dark theme color reference.
     * 
     * @return default subtenant dark theme color reference
     */
    public static SubtenantDarkThemeColorReference getDefault() {
        return CANVAS_BACKGROUND;
    }

    /**
     * Gets unknown subtenant dark theme color reference value.
     * 
     * @return unknown subtenant dark theme color reference
     */
    public static SubtenantDarkThemeColorReference getUnknownEnum() {
        return UNKNOWN_ENUM;
    }

    /**
     * Gets subtenant dark theme color reference from its string representation.
     * 
     * @param value
     *            string.
     * @return corresponding subtenant dark theme color reference or default subtenant dark theme color reference if not
     *         recognised.
     */
    public static SubtenantDarkThemeColorReference getValue(String value) {
        if (value == null) {
            return getDefault();
        }
        final String trimmedValue = value.trim();
        for (final SubtenantDarkThemeColorReference option : values()) {
