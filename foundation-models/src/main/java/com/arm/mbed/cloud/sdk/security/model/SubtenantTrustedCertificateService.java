...
@Preamble(
    description = "Subtenant trusted certificate service."
)
public enum SubtenantTrustedCertificateService implements SdkEnum {
   ...
   * @param value string.
   * @return corresponding subtenant trusted certificate service  or default subtenant trusted certificate service if not recognised. 
   */
   ...
   * @param obj1 a subtenant trusted certificate service.
   * @param obj2 a subtenant trusted certificate service.
