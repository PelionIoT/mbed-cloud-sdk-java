...
public class SubtenantApiKey implements SdkModel {
     ...
     * <p>
     * Note: Should not be used. Use {@link #SubtenantApiKey()} instead.
     * 
     * @param accountId
     *            The ID of the account.
     * @param createdAt
     ...
     */
    @Internal
    public SubtenantApiKey(SubtenantApiKey subtenantApiKey) {
        this(subtenantApiKey == null ? (String) null : subtenantApiKey.accountId,
             ...
             subtenantApiKey == null ? (String) null : subtenantApiKey.name,
             subtenantApiKey == null ? (String) null : subtenantApiKey.owner,
             subtenantApiKey == null ? SubtenantApiKeyStatus.getDefault() : subtenantApiKey.status,
             subtenantApiKey == null ? new Date() : subtenantApiKey.updatedAt);
    }
     ...
     *            The ID of the API key.
     */
    public SubtenantApiKey(String id) {
        this();
        setId(id);
    }
     ...
     * Note: the length of the string has to match {@code /[a-f0-9]{32}/} to be valid
     * 
     * @param subtenantApiKeyId
     *            The ID of the API key.
     */
    @Internal
    public void setSubtenantApiKeyId(String subtenantApiKeyId) {
        setId(subtenantApiKeyId);
    }
     ...
     * @return status
     */
    public SubtenantApiKeyStatus getStatus() {
        return status;
    }
     ...
     *            The status of the API key.
     */
    public void setStatus(SubtenantApiKeyStatus status) {
        this.status = status;
    }
    ...
    public void setStatus(String status) {
        this.status = SubtenantApiKeyStatus.getValue(status);
    }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SubtenantApiKey;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SubtenantApiKey)) {
            return false;
        }
        final SubtenantApiKey other = (SubtenantApiKey) obj;
    ...
    public boolean isValid() {
        return isAccountIdValid() && isIdValid() && isNameValid() && isOwnerValid();
    }
     ...
     */
    @Override
    public SubtenantApiKey clone() {
        return new SubtenantApiKey(this);
    }
}
