 ...
 * Account reference.
 */
@Preamble(description = "Account reference.")
public enum AccountReference implements SdkEnum {
     ...
     * Serialisation Id.
     */
    private static final long serialVersionUID = 1172537974133152L;
     ...
     */
    @Internal
    AccountReference(@DefaultValue("BRAND_LOGO_EMAIL") String string) {
        this.string = string;
    }
    ...
    /**
     * Gets default account reference.
     * 
     * @return default account reference
     */
    public static AccountReference getDefault() {
        return BRAND_LOGO_EMAIL;
    }

    /**
     * Gets unknown account reference value.
     * 
     * @return unknown account reference
     */
    public static AccountReference getUnknownEnum() {
        return UNKNOWN_ENUM;
    }

    /**
     * Gets account reference from its string representation.
     * 
     * @param value
     *            string.
     * @return corresponding account reference or default account reference if not recognised.
     */
    public static AccountReference getValue(String value) {
        if (value == null) {
            return getDefault();
        }
        final String trimmedValue = value.trim();
        for (final AccountReference option : values()) {
