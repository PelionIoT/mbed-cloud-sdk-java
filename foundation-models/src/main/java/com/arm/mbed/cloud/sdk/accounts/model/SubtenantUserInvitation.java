...
@Preamble(
    description = "Model for a subtenant user invitation."
)
public class SubtenantUserInvitation implements SdkModel {
   ...
   */
  @Internal
  public SubtenantUserInvitation(String accountId, Date createdAt, String email, Date expiration,
      String id, List loginProfiles, Date updatedAt, String userId) {
    super();
   ...
   * @param subtenantUserInvitationId The ID of the invitation.
   */
  @Internal
  ...
  public String toString() {
    return "SubtenantUserInvitation [accountId=" + accountId
        + ", createdAt=" + createdAt
        + ", email=" + email
