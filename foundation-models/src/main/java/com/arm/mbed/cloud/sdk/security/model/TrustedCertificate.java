...
public class TrustedCertificate implements SdkModel {
   ...
   * @param privateKey Private key of the certificate in PEM or base64 encoded DER format.
   ...
   */
  @Internal
  public TrustedCertificate(String accountId, String certificate, Date createdAt,
      String description, int deviceExecutionMode, boolean enrollmentMode, String id,
      boolean isDeveloperCertificate, String issuer, String name, String ownerId, String privateKey,
