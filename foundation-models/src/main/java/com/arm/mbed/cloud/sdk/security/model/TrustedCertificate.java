...
public class TrustedCertificate implements SdkModel {
    ...
    public TrustedCertificate(String accountId, String certificate, Date createdAt, String description,
                              ...
                              String privateKey, TrustedCertificateService service, TrustedCertificateStatus status,
    ...
    public TrustedCertificate(TrustedCertificate trustedCertificate) {
        this(trustedCertificate == null ? (String) null : trustedCertificate.accountId,
             ...
             trustedCertificate == null ? (String) null : trustedCertificate.privateKey,
    ...
    public TrustedCertificate() {
        this((String) null, (String) null, new java.util.Date(), (String) null, 0, false, (String) null, false,
    ...
    /**
     * Gets private key of the certificate in pem or base64 encoded der format.
     * 
     * @return privateKey
     */
    ...
    /**
     * Sets private key of the certificate in pem or base64 encoded der format.
     * 
     * @param privateKey
     *            Private key of the certificate in PEM or base64 encoded DER format.
     */
    ...
    public String toString() {
        return "TrustedCertificate [accountId=" + accountId + ", certificate=" + certificate + ", createdAt="
               + createdAt + ", description=" + description + ", deviceExecutionMode=" + deviceExecutionMode
               + ", enrollmentMode=" + enrollmentMode + ", id=" + id + ", isDeveloperCertificate="
               + isDeveloperCertificate + ", issuer=" + issuer + ", name=" + name + ", ownerId=" + ownerId
               + ", privateKey=" + privateKey + ", service=" + service + ", status=" + status + ", subject=" + subject
