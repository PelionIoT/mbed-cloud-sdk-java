...
public class UserInvitation implements SdkModel {
   ...
   * @param accountId The UUID of the account the user is invited to.
   ...
   * @param userId The UUID of the invited user.
   */
  @Internal
  public UserInvitation(String accountId, Date createdAt, String email, Date expiration,
      List<String> groups, String id, Date updatedAt, String userId) {
    super();
   ...
   * @param userInvitationId The UUID of the invitation.
   */
  @Internal
