...
@Preamble(
    description = "Model for a device enrollment bulk delete."
)
...
public class DeviceEnrollmentBulkDelete implements SdkModel {
   ...
   * @param accountId ID.
   * @param completedAt The time of completing the bulk creation task.
   * Null when creating bulk upload or delete.
   * 
   * @param createdAt The time of receiving the bulk creation task.
   * 
   * @param errorsCount The number of enrollment identities with failed processing.
   * 
   * @param errorsReportFile Link to error report file.
   * Null when creating bulk upload or delete.
   * 
   * @param fullReportFile Link to full report file.
   * Null when creating bulk upload or delete.
   * 
   * @param id Bulk ID.
   * @param processedCount The number of enrollment identities processed until now.
   * 
   * @param status The state of the process is 'new' at the time of creation. If the creation is still in progress, the state is shown as 'processing'. When the request has been fully processed, the state changes to 'completed'.
   * 
   * @param totalCount Total number of enrollment identities found in the input CSV.
   * 
   */
  @Internal
  public DeviceEnrollmentBulkDelete(String accountId, Date completedAt, Date createdAt,
      int errorsCount, String errorsReportFile, String fullReportFile, String id,
      int processedCount, @DefaultValue("new") DeviceEnrollmentBulkDeleteStatus status,
      int totalCount) {
    super();
  ...
  public DeviceEnrollmentBulkDelete(DeviceEnrollmentBulkDelete deviceEnrollmentBulkDelete) {
    this(deviceEnrollmentBulkDelete == null ? (String) null : deviceEnrollmentBulkDelete.accountId,
        ...
        deviceEnrollmentBulkDelete == null ? DeviceEnrollmentBulkDeleteStatus.getValue("new") : deviceEnrollmentBulkDelete.status,
  ...
  public DeviceEnrollmentBulkDelete() {
    this((String) null,
        ...
        (String) null,
        0,
        DeviceEnrollmentBulkDeleteStatus.getValue("new"),
        0);
  }
  ...
  /**
   * Gets link to error report file.
   * null when creating bulk upload or delete.
  ...
  /**
   * Sets link to error report file.
   * null when creating bulk upload or delete.
   * @param errorsReportFile Link to error report file.
   * Null when creating bulk upload or delete.
   * 
   ...
   * <p>
   * Note: the value has to match {@code /^[A-Za-z0-9]{32}/} to be valid
   * @param deviceEnrollmentBulkDeleteId Bulk ID.
   */
  @Internal
  ...
  /**
   * Gets the state of the process is 'new' at the time of creation. if the creation is still in progress, the state is shown as 'processing'. when the request has been fully processed, the state changes to 'completed'.
   * @return status
   */
  ...
  /**
   * Sets the state of the process is 'new' at the time of creation. if the creation is still in progress, the state is shown as 'processing'. when the request has been fully processed, the state changes to 'completed'.
   * @param status The state of the process is 'new' at the time of creation. If the creation is still in progress, the state is shown as 'processing'. When the request has been fully processed, the state changes to 'completed'.
   * 
   */
  ...
  public String toString() {
    return "DeviceEnrollmentBulkDelete [accountId=" + accountId
        + ", completedAt=" + completedAt
        + ", createdAt=" + createdAt
        + ", errorsCount=" + errorsCount
        + ", errorsReportFile=" + errorsReportFile
