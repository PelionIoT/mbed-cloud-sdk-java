...
@Preamble(
    description = "Certificate enrollment enroll status."
)
public enum CertificateEnrollmentEnrollStatus implements SdkEnum {
   ...
   * @param value string.
   * @return corresponding certificate enrollment enroll status  or default certificate enrollment enroll status if not recognised. 
   */
   ...
   * @param obj1 a certificate enrollment enroll status.
   * @param obj2 a certificate enrollment enroll status.
