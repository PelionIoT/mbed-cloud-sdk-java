...
public class User implements SdkModel {
  ...
  public User(String accountId, String address, Date createdAt, long creationTime, String email,
      ...
      String password, long passwordChangedTime, String phoneNumber, UserStatus status,
  ...
  public User(User user) {
    this(user == null ? (String) null : user.accountId,
        ...
        user == null ? null : user.loginProfiles,
        user != null && user.marketingAccepted,
        ...
        user != null && user.termsAccepted,
        user != null && user.twoFactorAuthentication,
   ...
   */
  @Internal
  public User(String accountId, Date createdAt, long creationTime, boolean emailVerified,
      long lastLoginTime, List<LoginHistory> loginHistory, long passwordChangedTime,
      Date updatedAt) {
    this(accountId,
        (String) null,
        createdAt,
