...
public class User implements SdkModel {
   ...
   * @param creationTime A timestamp of the user creation in the storage, in milliseconds.
   * @param email The email address.
   * @param emailVerified A flag indicating whether the user's email address has been verified or not.
   * @param fullName The full name of the user.
   * @param groups A list of IDs of the groups this user belongs to.
   * @param id The UUID of the user.
   * @param lastLoginTime A timestamp of the latest login of the user, in milliseconds.
   * @param loginHistory Timestamps, succeedings, IP addresses and user agent information of the last five logins of the user, with timestamps in RFC3339 format.
   * @param marketingAccepted A flag indicating that receiving marketing information has been accepted.
   * @param password The password when creating a new user. It will be generated when not present in the request.
   * @param passwordChangedTime A timestamp of the latest change of the user password, in milliseconds.
   ...
   * @param termsAccepted A flag indicating that the General Terms and Conditions has been accepted.
   * @param twoFactorAuthentication A flag indicating whether 2-factor authentication (TOTP) has been enabled.
  ...
  public User(String accountId, String address, Date createdAt, long creationTime, String email,
      ...
      List<LoginHistory> loginHistory, boolean marketingAccepted, String password,
      long passwordChangedTime, String phoneNumber, UserStatus status, boolean termsAccepted,
  ...
  public User(User user) {
    this(user == null ? (String) null : user.accountId,
        user == null ? (String) null : user.address,
        user == null ? new java.util.Date() : user.createdAt,
        user == null ? 0L : user.creationTime,
        user == null ? (String) null : user.email,
        user == null ? false : user.emailVerified,
        user == null ? (String) null : user.fullName,
        user == null ? null : user.groups,
        user == null ? (String) null : user.id,
        user == null ? 0L : user.lastLoginTime,
        user == null ? null : user.loginHistory,
        user == null ? false : user.marketingAccepted,
        user == null ? (String) null : user.password,
        user == null ? 0L : user.passwordChangedTime,
        user == null ? (String) null : user.phoneNumber,
        user == null ? UserStatus.getDefault() : user.status,
        user == null ? false : user.termsAccepted,
        user == null ? false : user.twoFactorAuthentication,
        user == null ? new java.util.Date() : user.updatedAt,
  ...
  /**
   * Gets timestamps, succeedings, ip addresses and user agent information of the last five logins of the user, with timestamps in rfc3339 format.
   * @return loginHistory
   */
  ...
  /**
   * Sets timestamps, succeedings, ip addresses and user agent information of the last five logins of the user, with timestamps in rfc3339 format.
   * @param loginHistory Timestamps, succeedings, IP addresses and user agent information of the last five logins of the user, with timestamps in RFC3339 format.
   */
  ...
  /**
   * Gets the status of the user. enrolling state indicates that the user is in the middle of the enrollment process. invited means that the user has not accepted the invitation request. reset means that the password must be changed immediately. inactive users are locked out and not permitted to use the system.
   * @return status
   */
  ...
  /**
   * Sets the status of the user. enrolling state indicates that the user is in the middle of the enrollment process. invited means that the user has not accepted the invitation request. reset means that the password must be changed immediately. inactive users are locked out and not permitted to use the system.
   * @param status The status of the user. ENROLLING state indicates that the user is in the middle of the enrollment process. INVITED means that the user has not accepted the invitation request. RESET means that the password must be changed immediately. INACTIVE users are locked out and not permitted to use the system.
   */
