...
/**
 * Light theme image reference.
 */
@Preamble(description = "Light theme image reference.")
public enum LightThemeImageReference implements SdkEnum {
     ...
     * Serialisation Id.
     */
    private static final long serialVersionUID = 1095828358129782L;
     ...
     */
    @Internal
    LightThemeImageReference(@DefaultValue("APP_LOGO_LANDSCAPE") String string) {
        this.string = string;
    }
    ...
    /**
     * Gets default light theme image reference.
     * 
     * @return default light theme image reference
     */
    public static LightThemeImageReference getDefault() {
        return APP_LOGO_LANDSCAPE;
    }

    /**
     * Gets unknown light theme image reference value.
     * 
     * @return unknown light theme image reference
     */
    public static LightThemeImageReference getUnknownEnum() {
        return UNKNOWN_ENUM;
    }

    /**
     * Gets light theme image reference from its string representation.
     * 
     * @param value
     *            string.
     * @return corresponding light theme image reference or default light theme image reference if not recognised.
     */
    public static LightThemeImageReference getValue(String value) {
        if (value == null) {
            return getDefault();
        }
        final String trimmedValue = value.trim();
        for (final LightThemeImageReference option : values()) {
