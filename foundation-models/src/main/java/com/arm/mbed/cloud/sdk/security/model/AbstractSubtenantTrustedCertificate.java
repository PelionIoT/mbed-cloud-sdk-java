...
@Preamble(
    description = "Model for a subtenant trusted certificate."
)
...
public abstract class AbstractSubtenantTrustedCertificate implements SdkModel {
  ...
  @Internal
  @SuppressWarnings("PMD.CyclomaticComplexity")
  public AbstractSubtenantTrustedCertificate(String accountId, String certificate,
      String certificateFingerprint, Date createdAt, String description, int deviceExecutionMode,
      boolean enrollmentMode, String id, String issuer, String name, String ownerId,
      SubtenantTrustedCertificateService service, SubtenantTrustedCertificateStatus status,
   ...
   * <p>
   * Note: Should not be used. Use {@link #AbstractSubtenantTrustedCertificate()} instead.
   * @param abstractSubtenantTrustedCertificate an abstract subtenant trusted certificate.
   */
  @Internal
  public AbstractSubtenantTrustedCertificate(
      AbstractSubtenantTrustedCertificate abstractSubtenantTrustedCertificate) {
    this(abstractSubtenantTrustedCertificate == null ? (String) null : abstractSubtenantTrustedCertificate.accountId,
        abstractSubtenantTrustedCertificate == null ? (String) null : abstractSubtenantTrustedCertificate.certificate,
        abstractSubtenantTrustedCertificate == null ? (String) null : abstractSubtenantTrustedCertificate.certificateFingerprint,
        abstractSubtenantTrustedCertificate == null ? new java.util.Date() : abstractSubtenantTrustedCertificate.createdAt,
        abstractSubtenantTrustedCertificate == null ? (String) null : abstractSubtenantTrustedCertificate.description,
        ...
        abstractSubtenantTrustedCertificate == null ? SubtenantTrustedCertificateService.getDefault() : abstractSubtenantTrustedCertificate.service,
        abstractSubtenantTrustedCertificate == null ? SubtenantTrustedCertificateStatus.getDefault() : abstractSubtenantTrustedCertificate.status,
        abstractSubtenantTrustedCertificate == null ? (String) null : abstractSubtenantTrustedCertificate.subject,
        abstractSubtenantTrustedCertificate == null ? new java.util.Date() : abstractSubtenantTrustedCertificate.updatedAt,
        abstractSubtenantTrustedCertificate == null ? new java.util.Date() : abstractSubtenantTrustedCertificate.validity);
  }
   ...
   */
  @Internal
  public AbstractSubtenantTrustedCertificate(String certificateFingerprint, Date createdAt,
      String issuer, String ownerId, String subject, Date updatedAt, Date validity) {
    this((String) null,
        (String) null,
   ...
   * @param subtenantTrustedCertificateId Entity ID.
   */
  @Internal
  ...
  public String toString() {
    return "AbstractSubtenantTrustedCertificate [accountId=" + accountId
