...
@Preamble(
    description = "Subtenant trusted certificate status."
)
public enum SubtenantTrustedCertificateStatus implements SdkEnum {
   ...
   * @param value string.
   * @return corresponding subtenant trusted certificate status  or default subtenant trusted certificate status if not recognised. 
   */
   ...
   * @param obj1 a subtenant trusted certificate status.
   * @param obj2 a subtenant trusted certificate status.
