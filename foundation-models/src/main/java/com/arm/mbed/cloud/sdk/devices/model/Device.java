...
public class Device implements SdkModel {
  ...
  @Internal
  @SuppressWarnings("PMD.CyclomaticComplexity")
  public Device(String accountId, Date createdAt, DeviceDeployedState deployedState,
      String endpointName, Date enrolmentListTimestamp, String lastOperatorSuspendedCategory,
      ...
      Date lastSystemSuspendedUpdatedAt, DeviceLifecycleStatus lifecycleStatus,
      Date manifestTimestamp, boolean operatorSuspended, boolean systemSuspended, Date updatedAt) {
    this(accountId,
        false,
        new java.util.Date(),
        new java.util.Date(),
