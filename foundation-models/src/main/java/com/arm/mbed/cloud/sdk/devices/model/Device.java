...
public class Device implements SdkModel {
   ...
   * @param customAttributes Up to five custom key-value attributes.
  ...
  public Device(String accountId, boolean autoUpdate, Date bootstrapExpirationDate,
      ...
      String firmwareChecksum, String hostGateway, String id, String manifest,
  ...
  public Device(Device device) {
    this(device == null ? (String) null : device.accountId,
        device == null ? false : device.autoUpdate,
