...
@Preamble(
    description = "Model for a subtenant user."
)
...
public class SubtenantUser implements SdkModel {
  ...
  @Internal
  @SuppressWarnings("PMD.CyclomaticComplexity")
  public SubtenantUser(String accountId, String address, Date createdAt, long creationTime,
      String email, boolean emailVerified, String fullName, String id, long lastLoginTime,
   ...
   * <p>
   * Note: Should not be used. Use {@link #SubtenantUser()} instead.
   * @param subtenantUser a subtenant user.
   */
  @Internal
   ...
   * @param subtenantUserId The ID of the user.
   */
  @Internal
  ...
  public String toString() {
    return "SubtenantUser [accountId=" + accountId
        + ", address=" + address
        + ", createdAt=" + createdAt
