...
@Preamble(
    description = "Model for a device enrollment bulk create."
)
...
public class DeviceEnrollmentBulkCreate implements SdkModel {
   ...
   */
  @Internal
  public DeviceEnrollmentBulkCreate(String accountId, Date completedAt, Date createdAt,
      int errorsCount, String errorsReportFile, String fullReportFile, String id,
      int processedCount, @DefaultValue("new") DeviceEnrollmentBulkCreateStatus status,
      int totalCount) {
    super();
  ...
  public DeviceEnrollmentBulkCreate(DeviceEnrollmentBulkCreate deviceEnrollmentBulkCreate) {
    this(deviceEnrollmentBulkCreate == null ? (String) null : deviceEnrollmentBulkCreate.accountId,
        ...
        deviceEnrollmentBulkCreate == null ? DeviceEnrollmentBulkCreateStatus.getValue("new") : deviceEnrollmentBulkCreate.status,
  ...
  public DeviceEnrollmentBulkCreate() {
    this((String) null,
        ...
        (String) null,
        0,
        DeviceEnrollmentBulkCreateStatus.getValue("new"),
        0);
  }
   ...
   * <p>
   * Note: the value has to match {@code /^[A-Za-z0-9]{32}/} to be valid
   * @param deviceEnrollmentBulkCreateId Bulk ID.
   */
  @Internal
  ...
  public String toString() {
    return "DeviceEnrollmentBulkCreate [accountId=" + accountId
