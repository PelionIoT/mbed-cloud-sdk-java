...
public class TestPasswordPolicy {
    ...
    public void testHashCode() {
        try {
            ...
            PasswordPolicy passwordpolicy2 = new PasswordPolicy(89);
            assertNotNull(passwordpolicy1);
            assertNotNull(passwordpolicy2);
            assertNotSame(passwordpolicy2, passwordpolicy1);
            assertEquals(passwordpolicy2, passwordpolicy1);
    ...
    public void testIsValid() {
        PasswordPolicy passwordpolicy = new PasswordPolicy(35);
    ...
    public void testEquals() {
        try {
            PasswordPolicy passwordpolicy1 = new PasswordPolicy(126);
            PasswordPolicy passwordpolicy2 = new PasswordPolicy(126);
            PasswordPolicy passwordpolicy3 = new PasswordPolicy(113);
            assertNotNull(passwordpolicy1);
            assertNotNull(passwordpolicy2);
