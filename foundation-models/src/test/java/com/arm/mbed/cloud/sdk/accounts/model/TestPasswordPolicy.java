...
public class TestPasswordPolicy {
    ...
    public void testEquals() {
        try {
            PasswordPolicy passwordpolicy1 = new PasswordPolicy(86);
            PasswordPolicy passwordpolicy2 = new PasswordPolicy(86);
            PasswordPolicy passwordpolicy3 = new PasswordPolicy(110);
            assertNotNull(passwordpolicy1);
            assertNotNull(passwordpolicy2);
