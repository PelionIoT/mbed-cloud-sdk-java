...
public class TestPasswordPolicy {
    ...
    public void testClone() {
        try {
            PasswordPolicy passwordpolicy1 = new PasswordPolicy(112);
    ...
    public void testEquals() {
        try {
            PasswordPolicy passwordpolicy1 = new PasswordPolicy(48);
            PasswordPolicy passwordpolicy2 = new PasswordPolicy(48);
            PasswordPolicy passwordpolicy3 = new PasswordPolicy(115);
            assertNotNull(passwordpolicy1);
            assertNotNull(passwordpolicy2);
