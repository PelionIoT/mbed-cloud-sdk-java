...
public class TestPasswordPolicy {
    ...
    public void testHashCode() {
        try {
            PasswordPolicy passwordpolicy1 = new PasswordPolicy(93);
            PasswordPolicy passwordpolicy2 = new PasswordPolicy(93);
            assertNotNull(passwordpolicy1);
            assertNotNull(passwordpolicy2);
            assertNotSame(passwordpolicy2, passwordpolicy1);
            assertEquals(passwordpolicy2, passwordpolicy1);
    ...
    public void testEquals() {
        try {
            PasswordPolicy passwordpolicy1 = new PasswordPolicy(20);
            PasswordPolicy passwordpolicy2 = new PasswordPolicy(20);
            PasswordPolicy passwordpolicy3 = new PasswordPolicy(61);
            assertNotNull(passwordpolicy1);
            assertNotNull(passwordpolicy2);
