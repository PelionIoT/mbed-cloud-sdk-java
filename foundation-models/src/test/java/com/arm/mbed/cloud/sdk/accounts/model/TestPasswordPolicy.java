...
public class TestPasswordPolicy {
    ...
    public void testHashCode() {
        try {
            PasswordPolicy passwordpolicy1 = new PasswordPolicy(11);
            PasswordPolicy passwordpolicy2 = new PasswordPolicy(11);
            assertNotNull(passwordpolicy1);
            assertNotNull(passwordpolicy2);
            assertNotSame(passwordpolicy2, passwordpolicy1);
            assertEquals(passwordpolicy2, passwordpolicy1);
    ...
    public void testEquals() {
        try {
            PasswordPolicy passwordpolicy1 = new PasswordPolicy(21);
            PasswordPolicy passwordpolicy2 = new PasswordPolicy(21);
