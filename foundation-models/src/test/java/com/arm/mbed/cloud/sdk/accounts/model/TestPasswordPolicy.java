...
public class TestPasswordPolicy {
    ...
    public void testEquals() {
        try {
            PasswordPolicy passwordpolicy1 = new PasswordPolicy(67);
            PasswordPolicy passwordpolicy2 = new PasswordPolicy(67);
            PasswordPolicy passwordpolicy3 = new PasswordPolicy(78);
            assertNotNull(passwordpolicy1);
            assertNotNull(passwordpolicy2);
