...
> UploadChunkInfo uploadJobChunkCreate(contentLength, uploadJobId, contentMD5, chunk)
...
String contentMD5 = "contentMD5_example"; // String | 
String chunk = "chunk_example"; // String | Chunk
try {
    UploadChunkInfo result = apiInstance.uploadJobChunkCreate(contentLength, uploadJobId, contentMD5, chunk);
    System.out.println(result);
} catch (ApiException e) {
