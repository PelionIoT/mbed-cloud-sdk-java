...
import com.arm.mbed.cloud.sdk.internal.statistics.CollectionFormats.*;
...
public interface AccountApi {
   ...
   * @param interval Group data by this interval in minutes, hours, days or weeks. Sample values: 5m, 2h, 3d, 4w. The maximum interval cannot exceed more than one year ( 365 days ) and so the allowed ranges are 5m - 525600m / 1h - 8760h / 1d - 365d / 1w - 53w.  (required)
   ...
   * @param limit The number of results to return. Default value is 50, minimum value is 2 and maximum value is 1000.  (optional)
