...
------------- | ------------- | -------------
[**getMetrics**](StatisticsApi.md#getMetrics) | **GET** v3/metrics | Provides account-specific statistics for other cloud services.
...
try {
    ...
    System.err.println("Exception when calling StatisticsApi#getMetrics");
    e.printStackTrace();
}
```
