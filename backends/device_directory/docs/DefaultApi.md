...
------------- | ------------- | -------------
[**blocksCreate**](DefaultApi.md#blocksCreate) | **POST** v3/device-blocks/ | Create a device block
[**blocksDelete**](DefaultApi.md#blocksDelete) | **DELETE** v3/device-blocks/{block_id} | Delete a device block
[**blocksList**](DefaultApi.md#blocksList) | **GET** v3/device-blocks/ | List all device blocks
[**blocksRetrieve**](DefaultApi.md#blocksRetrieve) | **GET** v3/device-blocks/{block_id} | Get a device block
[**blocksUpdate**](DefaultApi.md#blocksUpdate) | **PUT** v3/device-blocks/{block_id} | Update a device block
[**deviceBlocksCreate**](DefaultApi.md#deviceBlocksCreate) | **POST** v3/devices/{id}/blocks | Add a block to this device
[**deviceBlocksDelete**](DefaultApi.md#deviceBlocksDelete) | **DELETE** v3/devices/{id}/blocks/{block_id} | Delete a block for a device
[**deviceBlocksList**](DefaultApi.md#deviceBlocksList) | **GET** v3/devices/{id}/blocks | List all blocks for this device
[**deviceBlocksRetreive**](DefaultApi.md#deviceBlocksRetreive) | **GET** v3/devices/{id}/blocks/{block_id} | Get a block for a device
...
<a name="blocksCreate"></a>
# **blocksCreate**
> DeviceBlock blocksCreate(deviceBlock)
...
DeviceBlock deviceBlock = new DeviceBlock(); // DeviceBlock | 
try {
    DeviceBlock result = apiInstance.blocksCreate(deviceBlock);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling DefaultApi#blocksCreate");
    e.printStackTrace();
}
```
...
------------- | ------------- | ------------- | -------------
 **deviceBlock** | [**DeviceBlock**](DeviceBlock.md)|  |

### Return type

[**DeviceBlock**](DeviceBlock.md)
...
DefaultApi apiInstance = new DefaultApi();
String blockId = "blockId_example"; // String | The ID of the block
try {
    Void result = apiInstance.blocksDelete(blockId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling DefaultApi#blocksDelete");
    e.printStackTrace();
}
```
...
<a name="blocksList"></a>
# **blocksList**
> DeviceBlockPage blocksList(limit, order, after, include, filter)
...
try {
    DeviceBlockPage result = apiInstance.blocksList(limit, order, after, include, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling DefaultApi#blocksList");
    e.printStackTrace();
}
```
...
[**DeviceBlockPage**](DeviceBlockPage.md)
...
<a name="blocksRetrieve"></a>
# **blocksRetrieve**
> DeviceBlock blocksRetrieve(blockId)
...
String blockId = "blockId_example"; // String | The ID of the block
try {
    DeviceBlock result = apiInstance.blocksRetrieve(blockId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling DefaultApi#blocksRetrieve");
    e.printStackTrace();
}
```
...
<a name="blocksUpdate"></a>
# **blocksUpdate**
> DeviceBlock blocksUpdate(blockId, deviceBlock)
...
DeviceBlock deviceBlock = new DeviceBlock(); // DeviceBlock | 
try {
    DeviceBlock result = apiInstance.blocksUpdate(blockId, deviceBlock);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling DefaultApi#blocksUpdate");
    e.printStackTrace();
}
```
...
<a name="deviceBlocksCreate"></a>
# **deviceBlocksCreate**
> DeviceBlock deviceBlocksCreate(id, block)
...
DeviceBlock block = new DeviceBlock(); // DeviceBlock | Block a device from connecting to Pelion DM. A device block can be created by providing the ID of a existing block in the request body. Alternatively, providing a description and block type will automatically create a new device block and associate it with this device. Please note that if a device block ID is provided then all other parameters will be ignored.
try {
    DeviceBlock result = apiInstance.deviceBlocksCreate(id, block);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling DefaultApi#deviceBlocksCreate");
    e.printStackTrace();
}
```
 ...
 **block** | [**DeviceBlock**](DeviceBlock.md)| Block a device from connecting to Pelion DM. A device block can be created by providing the ID of a existing block in the request body. Alternatively, providing a description and block type will automatically create a new device block and associate it with this device. Please note that if a device block ID is provided then all other parameters will be ignored. |
...
<a name="deviceBlocksDelete"></a>
# **deviceBlocksDelete**
> Void deviceBlocksDelete(id, blockId)
...
String blockId = "blockId_example"; // String | The ID of the block
try {
    Void result = apiInstance.deviceBlocksDelete(id, blockId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling DefaultApi#deviceBlocksDelete");
    e.printStackTrace();
}
```
...
<a name="deviceBlocksList"></a>
# **deviceBlocksList**
> DeviceBlockPage deviceBlocksList(id, limit, order, after, include, filter)
...
String filter = "filter_example"; // String | URL encoded query string parameter to filter returned data.  ##### Filtering  ```?filter={URL encoded query string}```  The query string is made up of key/value pairs separated by ampersands. So for a query of ```key1=value1&key2=value2&key3=value3``` this would be encoded as follows: ```?filter=key1%3Dvalue1%26key2%3Dvalue2%26key3%3Dvalue3```  ###### Filterable fields:  The below table lists all the fields that can be filtered on with certain filters:  <table>   <thead>     <tr>       <th>Field</th>       <th>= / __eq / __neq</th>       <th>__in /  __nin</th>       <th>__lte / __gte</th>     <tr>   <thead>   <tbody>     <tr>       <td>id</td>       <td>✓</td>       <td>✓</td>       <td>&nbsp;</td>     </tr>     <tr>       <td>created_at</td>       <td>✓</td>       <td>✓</td>       <td>✓</td>     </tr>     <tr>       <td>block_type</td>       <td>✓</td>       <td>✓</td>       <td>&nbsp;</td>     </tr>     <tr>       <td>is_user_block</td>       <td>✓</td>       <td>✓</td>       <td>&nbsp;</td>     </tr>   </tbody> </table> &nbsp;  The examples below show the queries in *unencoded* form.  ###### By id:  ```id={id}```  ###### By state change:  ```is_user_block=[True|False]```  ###### By event type:  ```block_type={value}```  ###### On date-time fields:  Date-time fields should be specified in UTC RFC3339 format ```YYYY-MM-DDThh:mm:ss.msZ```. There are three permitted variations:  * UTC RFC3339 with milliseconds e.g. 2016-11-30T16:25:12.1234Z * UTC RFC3339 without milliseconds e.g. 2016-11-30T16:25:12Z * UTC RFC3339 shortened - without milliseconds and punctuation e.g. 20161130T162512Z  Date-time filtering supports three operators:  * equality * greater than or equal to &ndash; field name suffixed with ```__gte``` * less than or equal to &ndash; field name suffixed with ```__lte``` Lower and upper limits to a date-time range may be specified by including both the ```__gte``` and ```__lte``` forms in the filter. ```{field name}[|__lte|__gte]={UTC RFC3339 date-time}```  ##### Multi-field example  ```id=0158d38771f70000000000010010038c&is_user_block=True&26created_at__gte=2016-11-30T16:25:12.1234Z```  Encoded:  ```?filter=id%3D0158d38771f70000000000010010038c%is_user_block%3DTrue%26created_at__gte%3D2016-11-30T16%3A25%3A12.1234Z```  ##### Filtering with filter operators  String field filtering supports the following operators:  * equality: `__eq` * non-equality: `__neq` * in : `__in` * not in: `__nin`  For `__in` and `__nin` filters list of parameters must be comma-separated: `event_type__in=update.device.device-created,update.device.device-updated`
try {
    DeviceBlockPage result = apiInstance.deviceBlocksList(id, limit, order, after, include, filter);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling DefaultApi#deviceBlocksList");
    e.printStackTrace();
}
```
...
<a name="deviceBlocksRetreive"></a>
# **deviceBlocksRetreive**
> DeviceBlock deviceBlocksRetreive(id, blockId)
...
String blockId = "blockId_example"; // String | The ID of the block
try {
    DeviceBlock result = apiInstance.deviceBlocksRetreive(id, blockId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling DefaultApi#deviceBlocksRetreive");
    e.printStackTrace();
}
```
...
> Void groupMembersRetrieve(deviceGroupId, limit, order, after, include, filter)
...
try {
    Void result = apiInstance.groupMembersRetrieve(deviceGroupId, limit, order, after, include, filter);
    System.out.println(result);
} catch (ApiException e) {
