...
public class NotificationsApiTest {
     ...
     * Code | Description | |------|-------------| |**1000**|Socket closed by the client.| |**1001**|Going away. Set
     * when another socket was opened on the used channel, or if the channel was deleted with a REST call, or if the
     * server is shutting down.| |**1006**|Abnormal loss of connection. This code is never set by the service.|
     * |**1008**|Policy violation. Set when the API key is missing or invalid.| |**1011**|Unexpected condition. Socket
     * is closed with this status at an attempt to open a socket to an unexisting channel (without a prior REST PUT).
     * This code is also used to indicate closing socket for any other unexpected condition in the server.| **Example:**
     ...
     * **Example:** &#x60;&#x60;&#x60; curl -X PUT https://api.us-east-1.mbedcloud.com/v2/notification/websocket \\ -H
     * &#39;Authorization: Bearer &lt;api_key&gt;&#39; &#x60;&#x60;&#x60;
     */
    @Test
