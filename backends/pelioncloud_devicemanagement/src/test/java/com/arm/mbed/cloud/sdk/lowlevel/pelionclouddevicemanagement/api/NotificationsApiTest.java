...
public class NotificationsApiTest {
     ...
     * You should not make a GET &#x60;/v2/notification/pull&#x60; call for 2 minutes after channel was deleted, because
     * it can implicitly recreate the pull channel. You can also have some random responses with payload or 410 GONE
     * with \&quot;CHANNEL_DELETED\&quot; as a payload or 200/204 until the old channel is purged. **Example usage:**
     * curl -X DELETE https://api.us-east-1.mbedcloud.com/v2/notification/pull -H &#39;authorization: Bearer
     * {api-key}&#39;
     */
    @Test
     ...
     * API key at a time in Device Management Connect. If a callback notification channel already exists, you need to
     * delete it before creating a long poll notification channel, and vice-versa. **Example usage:** curl -X GET
     ...
     * when the URL is registered. For more information on callback notification, see
