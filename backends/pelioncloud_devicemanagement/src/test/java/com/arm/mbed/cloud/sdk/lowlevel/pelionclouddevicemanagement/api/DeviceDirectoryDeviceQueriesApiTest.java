...
/**
 * API tests for DeviceDirectoryDeviceQueriesApi
 */
public class DeviceDirectoryDeviceQueriesApiTest {

    private DeviceDirectoryDeviceQueriesApi api;

    @Before
    public void setup() {
        api = new ApiClient().createService(DeviceDirectoryDeviceQueriesApi.class);
    }
