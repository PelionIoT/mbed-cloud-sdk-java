...
/**
 * API tests for SecurityAndIdentityServerCredentialsApi
 */
public class SecurityAndIdentityServerCredentialsApiTest {

    private SecurityAndIdentityServerCredentialsApi api;

    @Before
    public void setup() {
        api = new ApiClient().createService(SecurityAndIdentityServerCredentialsApi.class);
    }
