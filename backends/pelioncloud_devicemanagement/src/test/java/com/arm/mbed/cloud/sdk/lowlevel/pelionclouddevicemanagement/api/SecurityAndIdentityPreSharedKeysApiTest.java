...
/**
 * API tests for SecurityAndIdentityPreSharedKeysApi
 */
public class SecurityAndIdentityPreSharedKeysApiTest {

    private SecurityAndIdentityPreSharedKeysApi api;

    @Before
    public void setup() {
        api = new ApiClient().createService(SecurityAndIdentityPreSharedKeysApi.class);
    }
