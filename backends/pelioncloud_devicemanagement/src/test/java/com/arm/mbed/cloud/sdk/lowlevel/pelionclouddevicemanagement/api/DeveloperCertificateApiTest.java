...
public class DeveloperCertificateApiTest {
     ...
     * flashed into multiple devices to connect to bootstrap server). **Note:** The number of developer certificates
     * allowed per account is limited. Please see [Using your own certificate
     ...
     * can be flashed into multiple devices to connect to bootstrap server). **Example usage:** curl -X GET
