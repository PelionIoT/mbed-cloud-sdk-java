...
public class PublicApiApiTest {
     ...
     * Bulk upload
     *
     * With bulk upload, you can upload a &#x60;CSV&#x60; file containing a number of enrollment IDs. **Example usage:**
     * &#x60;&#x60;&#x60; curl -X POST \\ -H &#39;Authorization: Bearer &lt;valid access token&gt;&#39; \\ -F
     ...
     * to delete the enrollment and do a factory reset for the device. For more information, see [Transferring the
     * ownership using
     ...
     * The report file is compliant with IETF Informal CSV common format [RFC
