...
/**
 * API tests for SecurityAndIdentityCertificateIssuersApi
 */
public class SecurityAndIdentityCertificateIssuersApiTest {

    private SecurityAndIdentityCertificateIssuersApi api;

    @Before
    public void setup() {
        api = new ApiClient().createService(SecurityAndIdentityCertificateIssuersApi.class);
    }

    /**
     * Create certificate issuer.
     *
     * Create a certificate issuer. &lt;br&gt; The maximum number of issuers is limited to 20 per account. &lt;br&gt;
     * You can create multiple certificate issuers of the same type, provided they have different names. This allows
     * verification of the certificate issuer configuration before activation. &lt;br&gt; **Example:**
     * &#x60;&#x60;&#x60; curl -X POST https://api.us-east-1.mbedcloud.com/v3/certificate-issuers \\ -H
     ...
     * https://api.us-east-1.mbedcloud.com/v3/certificate-issuers/0162155dc77d507b9d48a91b00000000 \\ -H
     ...
     *
     * **Note:** This endpoint does not use pagination, and therefore ignores list control parameters such as
     * &#x60;limit&#x60; or &#x60;after&#x60;.
     */
    @Test
     ...
     *
     * Update a certificate issuer. &lt;br&gt; **Example:** &#x60;&#x60;&#x60; curl -X PUT
     ...
     * the configuration is made active. &lt;br&gt; **Note:** The API requests the 3rd party CA to sign a test
     * certificate. For some 3rd party CAs, this operation may use the account quota. &lt;br&gt; **Example:**
     * &#x60;&#x60;&#x60; curl -X POST
