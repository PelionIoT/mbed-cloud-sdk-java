...
public class NotificationEntry implements Serializable {
  ...
  **/
   ...
   * @return errorMsg
  **/
  @ApiModelProperty(example = "Connection error.", value = "The error message if there was an error while transmitting the account notification.")
  ...
  **/
   ...
   * @return message
  **/
  @ApiModelProperty(example = "User limit has been reached.", value = "The message contained in this account notification entry.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.accountId, notificationEntry.accountId) &&
        ...
        Objects.equals(this.etag, notificationEntry.etag) &&
        Objects.equals(this.id, notificationEntry.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, createdAt, errorMsg, etag, id, message, object, receiver, subject, success, type);
  }
