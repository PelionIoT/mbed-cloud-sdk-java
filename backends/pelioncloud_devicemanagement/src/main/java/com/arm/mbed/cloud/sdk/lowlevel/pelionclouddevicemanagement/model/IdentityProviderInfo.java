...
import com.arm.mbed.cloud.sdk.lowlevel.pelionclouddevicemanagement.model.SAML2Info;
...
public class IdentityProviderInfo implements Serializable {
   ...
   * @return accountId
  **/
  @ApiModelProperty(example = "01619571e2e90242ac12000600000000", value = "The ID of the account the identity provider belongs to.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, createdAt, description, etag, id, name, object, saml2Attributes, status, type, updatedAt);
  }
