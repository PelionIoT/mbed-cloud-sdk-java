...
public class BulkResponse implements Serializable {
  ...
  **/
  @ApiModelProperty(example = "https://api.us-east-1.mbedcloud.com/v3/device-enrollments-bulk-uploads/2d238a89038b4ddb84699dd36a901063/errors_report.csv", required = true, value = "Link to error report file. Null when creating bulk upload or delete. ")
  ...
  **/
  @ApiModelProperty(example = "https://api.us-east-1.mbedcloud.com/v3/device-enrollments-bulk-uploads/2d238a89038b4ddb84699dd36a901063/full_report.csv", required = true, value = "Link to full report file. Null when creating bulk upload or delete. ")
