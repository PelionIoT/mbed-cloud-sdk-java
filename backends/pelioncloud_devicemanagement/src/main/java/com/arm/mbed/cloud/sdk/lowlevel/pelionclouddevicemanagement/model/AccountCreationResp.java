...
public class AccountCreationResp implements Serializable {
    ...
    @ApiModelProperty(example = "01619571e2e89242ac12000600000000", required = true,
                      value = "The ID of the admin user created.")
    ...
    @ApiModelProperty(example = "ak_1MDE2MTk1NzFmNmU4MDI0MmFjMTIwMDA2MDAwMDAwMDA01619571f7020242ac12000600000000B40IkJADMANmAscAj0Ot0n2yeQnyt9tT",
                      value = "The admin API key created for the account.")
    ...
    public int hashCode() {
        return Objects.hash(addressLine1, addressLine2, adminEmail, adminFullName, adminId, adminKey, adminName,
                            adminPassword, aliases, city, company, contact, contractNumber, country, customerNumber,
                            displayName, email, endMarket, id, phoneNumber, postalCode, state);
    }
