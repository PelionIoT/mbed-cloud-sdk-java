...
public class TrustedCertificateResp implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, certificate, certificateFingerprint, createdAt, description, deviceExecutionMode, enrollmentMode, etag, id, issuer, name, object, ownerId, service, status, subject, updatedAt, validity);
  }
