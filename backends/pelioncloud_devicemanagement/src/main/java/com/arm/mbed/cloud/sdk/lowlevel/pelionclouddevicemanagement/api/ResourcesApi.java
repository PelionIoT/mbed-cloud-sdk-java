...
public interface ResourcesApi {
     ...
     * Device Management Connect. All resource APIs are asynchronous. These APIs respond only if the device is on and
     * connected to Device Management Connect, and there is an active notification channel. **Example:**
    ...
    /**
     * Execute a function on a Resource or create new Object instance. [Execute a
     ...
     * new value to existing Resources](../connecting/handle-resource-webapp.html) or use the **write** attribute to set
     * [notification rules](../connecting/resource-change-webapp.html#notification-rules) for the Resources. The
     * notification rules only work on the device client side and may not be supported by all clients. This API can also
     * be used to transfer files to the device. Device Management Connect LwM2M server implements Option 1 from RFC7959.
     * The maximum block size is 1024 bytes. Note block size versus transferred file size in low-quality networks. The
