...
public interface UsageServiceMetricsApi {
    /**
     * Provides account-specific statistics for other cloud services. Get account-specific statistics.
     * 
     * @param include
     ...
     *            &#x60;device_proxy_request_error&#x60;, &#x60;device_subscription_request_success&#x60;,
     *            &#x60;device_subscription_request_error&#x60; and &#x60;device_observations&#x60; monitor only the
     *            response from the device to Device Management Connect. They do not confirm that the response is
     *            delivered to the client callback URLs used when you try to access device resources using [Connect
     *            API](https://developer.pelion.com/docs/device-management-api/connect/) endpoints. New metrics will be
     *            added to monitor the response delivery to client callback URLs later. **Example:** &#x60;&#x60;&#x60;
     *            curl -X GET
     *            https://api.us-east-1.mbedcloud.com/v3/metrics?include&#x3D;transactions,total_count&amp;start&#x3D;20170207&amp;end&#x3D;20170407&amp;interval&#x3D;1d
     *            \\ -H \&quot;Authorization : Bearer &lt;access_key&gt;\&quot; &#x60;&#x60;&#x60; **Response:** {
     ...
     *            interval cannot exceed one year (365 days). The allowed ranges are 5m-525600m/1h-8760h/1d-365d/1w-53w.
     *            (required)
     * @param start
     *            UTC time/year/date in RFC3339 format. Fetch the data with timestamp greater than or equal to this
     *            value. Sample values: 20170207T092056990Z/2017-02-07T09:20:56.990Z/2017/20170207. The time between
     *            start and end parameters cannot exceed one year (365 days). The parameter is not mandatory if the
     ...
     *            values: 20170207T092056990Z/2017-02-07T09:20:56.990Z/2017/20170207. The time between start and end
     *            parameters cannot exceed one year (365 days). The parameter is not mandatory if the period is
     *            specified. (optional)
     * @param period
     *            Period. Fetch the data for the period in minutes, hours, days or weeks. Sample values: 5m, 2h, 3d, 4w.
     *            The parameter is not mandatory if the start and end time are specified. The period cannot exceed one
     *            year (365 days). The allowed ranges are 5m-525600m/1h-8760h/1d-365d/1w-53w. (optional)
     * @param limit
     *            The number of results to return (2-1000). Default 50. (optional)
     * @param after
     *            The metric ID after which to start fetching. This also can be used for pagination. **Example:**
     *            &#x60;&#x60;&#x60; curl -X GET
     ...
     *            \\ -H \&quot;Authorization : Bearer &lt;access_key&gt;\&quot; &#x60;&#x60;&#x60; **Response:**
     *            &#x60;&#x60;&#x60; { \&quot;object\&quot;: \&quot;list\&quot;, \&quot;limit\&quot;: 20,
     *            \&quot;total_count\&quot;: 54, \&quot;has_more\&quot;: true, \&quot;data\&quot;: [ { \&quot;id\&quot;:
     ...
     *            \\ -H \&quot;Authorization : Bearer &lt;access_key&gt;\&quot; &#x60;&#x60;&#x60; **Response:**
     *            &#x60;&#x60;&#x60; { \&quot;object\&quot;: \&quot;list\&quot;, \&quot;limit\&quot;: 20,
     *            \&quot;total_count\&quot;: 54, \&quot;after\&quot;: \&quot;2017-07-26T00:00:00Z\&quot;,
     *            \&quot;has_more\&quot;: true, \&quot;data\&quot;: [ { \&quot;id\&quot;:
     *            \&quot;015d8157c800015e306fffff005374617473000\&quot;, \&quot;timestamp\&quot;:
     *            \&quot;2017-07-27T00:00:00Z\&quot;, \&quot;transactions\&quot;: 27366 }, . . . { \&quot;id\&quot;:
     *            \&quot;015de3309c00015e306fffff005374617473000\&quot;, \&quot;timestamp\&quot;:
