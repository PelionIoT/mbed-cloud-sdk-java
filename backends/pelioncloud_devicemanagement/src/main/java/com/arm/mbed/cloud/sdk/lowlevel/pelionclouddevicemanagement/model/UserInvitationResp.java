...
import com.arm.mbed.cloud.sdk.lowlevel.pelionclouddevicemanagement.model.LoginProfileResp;
...
public class UserInvitationResp implements Serializable {
   ...
   * @return accountId
  **/
  @ApiModelProperty(example = "01619571e2e90242ac12000600000000", required = true, value = "The ID of the account the user is invited to.")
  ...
  **/
   ...
   * @return id
  **/
  @ApiModelProperty(example = "01619571e2e89242ac12000600000000", required = true, value = "The ID of the invitation.")
  public String getId() {
    return id;
  }
  ...
  **/
   ...
   * @return userId
  **/
  @ApiModelProperty(example = "01619571e2e90242ac12000600000000", required = true, value = "The ID of the invited user.")
