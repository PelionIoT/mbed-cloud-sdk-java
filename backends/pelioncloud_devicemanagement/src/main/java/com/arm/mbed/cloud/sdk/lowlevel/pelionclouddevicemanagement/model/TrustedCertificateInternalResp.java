...
public class TrustedCertificateInternalResp implements Serializable {
     ...
     * @return privateKey
     **/
    @ApiModelProperty(example = "MIICdwIBADANBgkqhkiG9w0BAQEFAASCAmE...", required = true,
                      value = "Private key of the certificate in PEM or base64 encoded DER format.")
    ...
    public int hashCode() {
        return Objects.hash(accountId, certificate, certificateFingerprint, createdAt, description, deviceExecutionMode,
                            enrollmentMode, etag, id, issuer, name, object, ownerId, privateKey, service, status,
                            subject, updatedAt, validity);
    }
