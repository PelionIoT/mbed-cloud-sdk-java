...
public class TrustedCertificateInternalResp implements Serializable {
  ...
  **/
  ...
  public TrustedCertificateInternalResp certificateFingerprint(String certificateFingerprint) {
  ...
  **/
  @ApiModelProperty(example = "a10fb2c8ba90e6de927bd0ae391dcc38f6115685de2d7024712af37ead0608f1", required = true, value = "A SHA-256 fingerprint of the certificate.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.accountId, trustedCertificateInternalResp.accountId) &&
        ...
        Objects.equals(this.certificateFingerprint, trustedCertificateInternalResp.certificateFingerprint) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, certificate, certificateFingerprint, createdAt, description, deviceExecutionMode, enrollmentMode, etag, id, issuer, name, object, ownerId, privateKey, service, status, subject, updatedAt, validity);
  }
