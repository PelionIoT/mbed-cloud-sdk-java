...
public interface AccountAdminApi {
   ...
   * @param body Details of the service provider certificate to be generated. (optional)
   * @return Call&lt;IdentityProviderInfo&gt;
   */
  @Headers({
    "Content-Type:application/json"
  ...
  Call<UserInvitationRespList> getAllInvitations(
    @retrofit2.http.Query("limit") Integer limit, @retrofit2.http.Query("after") String after, @retrofit2.http.Query("order") String order, @retrofit2.http.Query("login_profile__eq") String loginProfileEq
  );
