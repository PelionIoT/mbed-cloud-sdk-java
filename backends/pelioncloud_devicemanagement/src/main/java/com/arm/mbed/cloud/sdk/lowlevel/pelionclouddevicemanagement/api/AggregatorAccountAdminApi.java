...
public interface AggregatorAccountAdminApi {
   ...
   * @param apikeyId The ID of the API key to be added to the group. (required)
   ...
   * @param accountId Account ID. (required)
   * @param body List of branding colors. (required)
   * @return Call&lt;Void&gt;
   */
  @Headers({
    "Content-Type:application/json"
   ...
   * @param accountId Account ID. (required)
   * @param reference Name of the branding images (icon or picture). (required)
   * @return Call&lt;Void&gt;
   */
   ...
   * @param accountId Account ID. (required)
   * @param apikeyId The ID of the API key to be deleted. (required)
   * @return Call&lt;Void&gt;
   */
   ...
   * @param body Details of the service provider certificate to be generated. (required)
   * @return Call&lt;IdentityProviderInfo&gt;
   */
  @Headers({
    "Content-Type:application/json"
   ...
   * @param accountId Account ID. (required)
   * @param apikeyId The ID of the API key to be retrieved. (required)
   * @return Call&lt;ApiKeyInfoResp&gt;
   */
   ...
   * @param keyEq API key filter. Do not include the private part of the API key (the last 32 characters). (optional)
   ...
   * @param statusEq Filter for certificate status (optional)
   ...
   * @param after The entity ID to fetch after the given one. (optional)
   * @param order The order of the records based on creation time, ASC or DESC; by default ASC (optional, default to ASC)
   * @param loginProfileEq Filter for getting user invitations by a specified login profile. (optional)
   ...
   * @param loginProfileEq An optional filter for getting users with a specified login profile. (optional)
   ...
   * @param accountId Account ID. (required)
   * @param apikeyId The ID of the API key whose details are retrieved. (required)
   * @param limit The number of results to return (2-1000), default is 50. (optional, default to 50)
   * @param after The entity ID to fetch after the given one. (optional)
   * @param order The order of the records based on creation time, ASC or DESC; by default ASC (optional, default to ASC)
   * @param include Comma separated additional data to return. Currently supported: total_count (optional)
   ...
   * @param accountId Account ID. (required)
   * @param apikeyId The ID of the API key to be removed from the group. (required)
   * @param body A list of IDs of the groups to be updated. (required)
   * @return Call&lt;UpdatedResponse&gt;
   */
  @Headers({
   ...
   * @param accountId Account ID. (required)
   * @param groupId The ID of the group from which the API keys are to be removed. (required)
   ...
   * @param accountId Account ID. (required)
   * @param groupId The ID of the group from which the users are to be removed. (required)
   ...
   * @param accountId Account ID. (required)
   * @param apikeyId The ID of the API key to be reset. (required)
   * @return Call&lt;ApiKeyInfoResp&gt;
   */
   ...
   * @param accountId Account ID. (required)
   * @param reference The name of the branding color. (required)
   * @param body The branding color. (required)
   * @return Call&lt;BrandingColor&gt;
   */
  @Headers({
    "Content-Type:application/json"
   ...
   * @param accountId Account ID. (required)
   * @param apikeyId The ID of the API key to be updated. (required)
   ...
   * @param accountId Account ID. (required)
   * @param reference Name of the branding images (icon or picture). (required)
   * @param body The image in PNG or JPEG format. (required)
   * @return Call&lt;BrandingImage&gt;
   */
  @Headers({
