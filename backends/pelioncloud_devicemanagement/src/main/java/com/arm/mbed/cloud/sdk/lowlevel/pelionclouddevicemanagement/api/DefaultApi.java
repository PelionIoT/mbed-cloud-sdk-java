...
public interface DefaultApi {
    ...
    Call<DeviceEventPage>
        deviceEventList(@retrofit2.http.Query("limit") Integer limit, @retrofit2.http.Query("order") String order,
                        ...
                        @retrofit2.http.Query("date_time__in") DateTime dateTimeIn,
                        @retrofit2.http.Query("date_time__nin") DateTime dateTimeNin,
                        ...
                        @retrofit2.http.Query("state_change__in") Boolean stateChangeIn,
                        @retrofit2.http.Query("state_change__nin") Boolean stateChangeNin);
    ...
    Call<DevicePage>
        deviceList(@retrofit2.http.Query("limit") Integer limit, @retrofit2.http.Query("order") String order,
                   ...
                   @retrofit2.http.Query("auto_update__in") Boolean autoUpdateIn,
                   @retrofit2.http.Query("auto_update__nin") Boolean autoUpdateNin,
                   ...
                   @retrofit2.http.Query("bootstrapped_timestamp__in") DateTime bootstrappedTimestampIn,
                   @retrofit2.http.Query("bootstrapped_timestamp__nin") DateTime bootstrappedTimestampNin,
                   ...
                   @retrofit2.http.Query("connector_expiration_date__in") LocalDate connectorExpirationDateIn,
                   @retrofit2.http.Query("connector_expiration_date__nin") LocalDate connectorExpirationDateNin,
                   ...
                   @retrofit2.http.Query("created_at__in") DateTime createdAtIn,
                   @retrofit2.http.Query("created_at__nin") DateTime createdAtNin,
                   ...
                   @retrofit2.http.Query("device_execution_mode__in") Integer deviceExecutionModeIn,
                   @retrofit2.http.Query("device_execution_mode__nin") Integer deviceExecutionModeNin,
                   ...
                   @retrofit2.http.Query("manifest_timestamp__in") DateTime manifestTimestampIn,
                   @retrofit2.http.Query("manifest_timestamp__nin") DateTime manifestTimestampNin,
                   ...
                   @retrofit2.http.Query("updated_at__in") DateTime updatedAtIn,
                   @retrofit2.http.Query("updated_at__nin") DateTime updatedAtNin,
    ...
    Call<FirmwareImagePage>
        firmwareImageList(@retrofit2.http.Query("limit") Integer limit, @retrofit2.http.Query("order") String order,
                          ...
                          @retrofit2.http.Query("datafile_size__in") Long datafileSizeIn,
                          @retrofit2.http.Query("datafile_size__nin") Long datafileSizeNin,
                          @retrofit2.http.Query("description__eq") String descriptionEq,
                          @retrofit2.http.Query("description__neq") String descriptionNeq,
                          @retrofit2.http.Query("description__in") String descriptionIn,
                          @retrofit2.http.Query("description__nin") String descriptionNin,
    ...
    Call<FirmwareManifestPage>
        firmwareManifestList(@retrofit2.http.Query("limit") Integer limit, @retrofit2.http.Query("order") String order,
                             ...
                             @retrofit2.http.Query("name__in") String nameIn,
                             @retrofit2.http.Query("name__nin") String nameNin,
                             @retrofit2.http.Query("timestamp__in") DateTime timestampIn,
                             @retrofit2.http.Query("timestamp__nin") DateTime timestampNin,
    ...
    Call<DeviceGroupPage>
        groupList(@retrofit2.http.Query("limit") Integer limit, @retrofit2.http.Query("order") String order,
                  ...
                  @retrofit2.http.Query("devices_count__in") Integer devicesCountIn,
                  @retrofit2.http.Query("devices_count__nin") Integer devicesCountNin,
    ...
    Call<UpdateCampaignPage>
        updateCampaignList(@retrofit2.http.Query("limit") Integer limit, @retrofit2.http.Query("order") String order,
                           ...
                           @retrofit2.http.Query("finished__in") DateTime finishedIn,
                           @retrofit2.http.Query("finished__nin") DateTime finishedNin,
                           ...
                           @retrofit2.http.Query("started_at__in") DateTime startedAtIn,
                           @retrofit2.http.Query("started_at__nin") DateTime startedAtNin,
                           ...
                           @retrofit2.http.Query("updated_at__lte") DateTime updatedAtLte,
                           @retrofit2.http.Query("updated_at__gte") DateTime updatedAtGte,
                           @retrofit2.http.Query("when__in") DateTime whenIn,
                           @retrofit2.http.Query("when__nin") DateTime whenNin,
    ...
    Call<UploadChunkInfoPage>
        uploadJobChunkList(@retrofit2.http.Path(value = "upload_job_id", encoded = true) String uploadJobId,
                           ...
                           @retrofit2.http.Query("id__in") Integer idIn, @retrofit2.http.Query("id__nin") Integer idNin,
                           @retrofit2.http.Query("updated_at__in") DateTime updatedAtIn,
                           @retrofit2.http.Query("updated_at__nin") DateTime updatedAtNin,
                           @retrofit2.http.Query("updated_at__lte") DateTime updatedAtLte,
                           @retrofit2.http.Query("updated_at__gte") DateTime updatedAtGte,
                           ...
                           @retrofit2.http.Query("length__in") Integer lengthIn,
                           @retrofit2.http.Query("length__nin") Integer lengthNin,
