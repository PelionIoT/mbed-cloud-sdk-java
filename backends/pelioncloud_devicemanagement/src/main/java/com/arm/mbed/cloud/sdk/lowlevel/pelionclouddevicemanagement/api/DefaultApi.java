...
public interface DefaultApi {
  ...
  Call<DeviceBlockCategoryPage> blockCategoriesList(
   ...
   * @param blockCategoryReference The reference of the block category (required)
   ...
   * @param accountId The ID of the account whose branding colors to be fetched. (required)
   ...
   * @param accountId The ID of the account whose branding images to be fetched. (required)
   ...
   * @param accountId The ID of the account whose branding colors to be fetched. (required)
   * @param reference The name of the branding color. (required)
   ...
   * @param accountId The ID of the account whose branding image to be fetched. (required)
   * @param reference Name of the picture whose metadata to be fetched. (required)
