...
public interface CertificateIssuersApi {
    /**
     * Create certificate issuer. Create a certificate issuer. The maximum number of issuers is limited to 20 per
     * account. Multiple certificate issuers of the same issuer type can be created, provided they have a different
     * name. This allows verification of the certificate issuer configuration before activating it. &lt;br&gt; **Example
     * usage:** &#x60;&#x60;&#x60; curl -X POST \\ -H &#39;authorization: Bearer &lt;valid access token&gt;&#39; \\ -H
     * &#39;content-type: application/json;charset&#x3D;UTF-8&#39; \\
     * https://api.us-east-1.mbedcloud.com/v3/certificate-issuers \\ -d &#39;{ \&quot;issuer_type\&quot;:
     * \&quot;GLOBAL_SIGN\&quot;, \&quot;name\&quot;: \&quot;GS Issuer\&quot;, \&quot;description\&quot;: \&quot;Sample
     * GlobalSign certificate issuer\&quot;, \&quot;issuer_attributes\&quot;: null, \&quot;issuer_credentials\&quot;: {
     * \&quot;api_key\&quot;: \&quot;e510e289e6cd8947\&quot;, \&quot;api_secret\&quot;:
    ...
    Call<CertificateIssuerInfo>
        createCertificateIssuer(@retrofit2.http.Body CertificateIssuerRequest certificateIssuerRequest);

    /**
     * Delete certificate issuer. Delete a certificate issuer by ID. &lt;br&gt; **Example usage:** &#x60;&#x60;&#x60;
     ...
     *            Certificate issuer ID. &lt;br&gt; The ID of the certificate issuer. An active certificate issuer may
     *            not be deleted. (required)
     * @return Call&lt;Void&gt;
     */
     ...
     * 
     * @param certificateIssuerId
     *            Certificate issuer ID. The ID of the certificate issuer. (required)
     * @return Call&lt;CertificateIssuerInfo&gt;
     */
    @GET("v3/certificate-issuers/{certificate-issuer-id}")
    Call<CertificateIssuerInfo> getCertificateIssuer(@retrofit2.http.Path(value = "certificate-issuer-id",
                                                                          encoded = true) String certificateIssuerId);

    /**
     * Get certificate issuers list. Note: This endpoint does not implement pagination and therefore, list control
    ...
    Call<CertificateIssuerInfoListResponse> getCertificateIssuers(@retrofit2.http.Query("limit") Integer limit,
    ...
    /**
     * Update certificate issuer. Update a certificate issuer. &lt;br&gt; **Example usage:** &#x60;&#x60;&#x60; curl -X
     * PUT \\ -H &#39;authorization: &lt;valid access token&gt;&#39; \\ -H &#39;content-type:
     ...
     * 
     * @param certificateIssuerId
     *            Certificate issuer ID. &lt;br&gt; The ID of the certificate issuer. (required)
    ...
    /**
     * Verify certificate issuer. A utility API that can be used to validate the user configuration before activating a
     * certificate issuer. Verifies that the certificate issuer is accessible and can be used to generate certificates
     * by Device Management. &lt;br&gt; **Note:** The API requests the 3rd party CA to sign a test certificate. For some
     * 3rd party CAs, this operation may make use of the account quota. &lt;br&gt; **Example usage:** &#x60;&#x60;&#x60;
     * curl -X POST \\ -H &#39;authorization: &lt;valid access token&gt;&#39; \\ -H &#39;content-type:
     * application/json;charset&#x3D;UTF-8&#39; \\
    ...
    Call<CertificateIssuerVerifyResponse>
