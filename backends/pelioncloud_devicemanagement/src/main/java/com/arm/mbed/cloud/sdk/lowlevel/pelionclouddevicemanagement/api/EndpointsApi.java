...
public interface EndpointsApi {
   ...
   */
  @GET("v2/endpoints")
  Call<List<Endpoint>> getConnectedEndpoints(
   ...
   * @param deviceId A unique device ID for an endpoint. Note that the ID needs to be an exact match. You cannot use wildcards here.  (required)
