...
public class AccountResponseList implements Serializable {
    ...
    @SerializedName("data")
    private List<AccountResponse> data = null;
    ...
    public AccountResponseList addDataItem(AccountResponse dataItem) {
        if (this.data == null) {
            this.data = new ArrayList<AccountResponse>();
        }
