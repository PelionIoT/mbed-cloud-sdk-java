...
public class ResourcesApiTest {
     ...
     */
    @Test
    public void executeResourceFunctionOrCreateResourcePathTest() {
        String deviceId = null;
        String resourcePath = null;
        String resourceFunction = null;
        Boolean noResp = null;
        // AsyncID response = api.executeResourceFunctionOrCreateResourcePath(deviceId, resourcePath, resourceFunction, noResp);
