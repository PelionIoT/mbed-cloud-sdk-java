...
public interface DeviceRequestsApi {
  ...
  @POST("v2/device-requests/{deviceId}")
  Call<Void> v2DeviceRequestsDeviceIdPost(
    @retrofit2.http.Path(value = "deviceId", encoded = true) String deviceId, @retrofit2.http.Query("asyncId") String asyncId, @retrofit2.http.Body DeviceRequest body
  );
