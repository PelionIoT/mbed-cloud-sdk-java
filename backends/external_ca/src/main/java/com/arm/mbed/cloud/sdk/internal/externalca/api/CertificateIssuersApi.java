...
public interface CertificateIssuersApi {
   ...
   * @param certificateIssuerRequest Certificate issuer request. (required)
  ...
  Call<CertificateIssuerInfo> createCertificateIssuer(
    @retrofit2.http.Body CertificateIssuerRequest certificateIssuerRequest
  );
   ...
   * @param certificateIssuerId Certificate issuer ID. &lt;br&gt; The ID of the certificate issuer. An active certificate issuer may not be deleted.  (required)
   * @return Call&lt;Void&gt;
   */
  @Headers({
    "Content-Type:application/json; charset=utf-8"
   ...
   * 
   * @param certificateIssuerId Certificate issuer ID. The ID of the certificate issuer.  (required)
   * @return Call&lt;CertificateIssuerInfo&gt;
   */
  @Headers({
    "Content-Type:application/json; charset=utf-8"
   ...
   * @param certificateIssuerId Certificate issuer ID. &lt;br&gt; The ID of the certificate issuer.  (required)
   * @param certificateIssuerUpdateRequest Certificate issuer update request. (required)
   * @return Call&lt;CertificateIssuerInfo&gt;
   */
  @Headers({
    "Content-Type:application/json; charset=utf-8"
