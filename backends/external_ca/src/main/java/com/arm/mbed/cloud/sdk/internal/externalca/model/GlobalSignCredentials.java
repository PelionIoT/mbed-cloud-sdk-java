...
public class GlobalSignCredentials implements Serializable {
   ...
   * @return apiKey
  **/
  @ApiModelProperty(example = "e510e289e6cd8947", required = true, value = "Unique ID for API client (provided by GlobalSign). ")
   ...
   * @return apiSecret
  **/
  @ApiModelProperty(example = "a477a8393d17a55ecb2ba6a61f58feb84770b621", required = true, value = "API Secret matching the API key (provided by GlobalSign). ")
  ...
  **/
   ...
   * @return passphrase
  **/
  @ApiModelProperty(example = "helloworld", value = "The passphrase to decrypt the private key in case it is encrypted. Empty if the private key is not encrypted. ")
