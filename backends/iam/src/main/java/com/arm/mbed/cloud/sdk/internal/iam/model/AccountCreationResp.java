...
public class AccountCreationResp implements Serializable {
  ...
  @SerializedName("enrollment_link")
  ...
  **/
  ...
  public AccountCreationResp enrollmentLink(String enrollmentLink) {
  ...
  **/
  @ApiModelProperty(value = "The enrollment finalisation link which can be provided for the customer.")
  ...
  **/
   ...
   * @return adminId
  **/
  @ApiModelProperty(required = true, value = "The ID of the admin user created.")
  ...
  **/
   ...
   * @return adminKey
  **/
  @ApiModelProperty(value = "The admin API key created for the account.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.addressLine2, accountCreationResp.addressLine2) &&
        ...
        Objects.equals(this.enrollmentLink, accountCreationResp.enrollmentLink) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addressLine2, city, addressLine1, enrollmentLink, country, company, postalCode, adminId, email, state, contact, adminKey, adminPassword, adminName, adminFullName, displayName, endMarket, adminEmail, phoneNumber, id, aliases);
  }
