package com.arm.mbed.cloud.sdk.internal.bootstrap.api;

import com.arm.mbed.cloud.sdk.internal.bootstrap.ApiClient;
import com.arm.mbed.cloud.sdk.internal.bootstrap.model.PreSharedKey;
import com.arm.mbed.cloud.sdk.internal.bootstrap.model.PreSharedKeyWithoutSecret;
...
public class PreSharedKeysApiTest {
     ...
     */
    @Test
    public void deleteAPreSharedKeyTest() {
        String endpointName = null;
        // Void response = api.deleteAPreSharedKey(endpointName);
     ...
     */
    @Test
    public void getAPreSharedKeyTest() {
        String endpointName = null;
        // PreSharedKeyWithoutSecret response = api.getAPreSharedKey(endpointName);
     ...
     */
    @Test
    public void uploadAPreSharedKeyTest() {
        PreSharedKey body = null;
        // Void response = api.uploadAPreSharedKey(body);
