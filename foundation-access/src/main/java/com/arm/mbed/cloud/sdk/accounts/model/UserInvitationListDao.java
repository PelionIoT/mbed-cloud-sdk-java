...
public class UserInvitationListDao extends AbstractModelListDao<UserInvitation, UserInvitationListOptions>
     ...
     *             if an error occurs during the process.
     */
    public UserInvitationListDao(ApiClientWrapper client) throws MbedCloudException {
        super(client);
    }
     ...
     *             if an error occurs during the process.
     */
    public UserInvitationListDao(ConnectionOptions options) throws MbedCloudException {
        super(options);
    }
     ...
     *             if an error occurs during the process.
     */
    public UserInvitationListDao(SdkContext sdkContext) throws MbedCloudException {
        super(sdkContext);
    }
