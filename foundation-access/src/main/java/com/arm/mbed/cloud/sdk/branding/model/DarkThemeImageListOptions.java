...
/**
 * Options to use when listing dark theme images.
 * <p>
 * Note:
 * <ul>
 * <li>Filters:
 * <p>
 * The list can be filtered server-side on some of the fields of a dark theme image.
 * <p>
 ...
 * </ul>
 */
@Preamble(description = "Options to use when listing dark theme images.")
@SuppressWarnings("PMD.AvoidDuplicateLiterals")
public class DarkThemeImageListOptions extends ListOptions {
    /**
     ...
     * <p>
     * Note: Should not be used. Use {@link #DarkThemeImageListOptions()} instead.
     * 
     * @param pageSize
     *            value.
     * @param maxResults
     ...
     */
    @Internal
    public DarkThemeImageListOptions(Integer pageSize, Long maxResults, Order order, String after,
     ...
     * Note: Should not be used. Use {@link #DarkThemeImageListOptions()} instead.
     * 
     * @param darkThemeImageListOptions
     *            a dark theme image list options.
     */
    @Internal
    public DarkThemeImageListOptions(DarkThemeImageListOptions darkThemeImageListOptions) {
        this();
        setOptions(darkThemeImageListOptions);
    }

    /**
     * Constructor.
     */
    public DarkThemeImageListOptions() {
        super();
        setDefault();
    }
     ...
     */
    @Internal
    public DarkThemeImageListOptions(String after, List<IncludeField> include, Filters filter) {
    ...
    public String toString() {
        return "DarkThemeImageListOptions [pageSize=" + pageSize + ", maxResults=" + maxResults + ", order=" + order
               + ", after=" + after + ", include="
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DarkThemeImageListOptions;
    }
     ...
     */
    @Override
    public DarkThemeImageListOptions clone() {
        final DarkThemeImageListOptions opt = new DarkThemeImageListOptions();
        opt.setOptions(this);
        return opt;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof DarkThemeImageListOptions)) {
            return false;
        }
        final DarkThemeImageListOptions other = (DarkThemeImageListOptions) obj;
