...
/**
 * Options to use when listing subtenant policy groups.
 * <p>
 * Note:
 * <ul>
 * <li>Filters:
 * <p>
 * The list can be filtered server-side on some of the fields of a subtenant policy group.
 * <p>
 ...
 * </ul>
 */
@Preamble(description = "Options to use when listing subtenant policy groups.")
...
public class SubtenantPolicyGroupListOptions extends ListOptions {
     ...
     * <p>
     * Note: Should not be used. Use {@link #SubtenantPolicyGroupListOptions()} instead.
     * 
     * @param pageSize
     *            value.
     * @param maxResults
     ...
     */
    @Internal
    public SubtenantPolicyGroupListOptions(Integer pageSize, Long maxResults, Order order, String after,
     ...
     * Note: Should not be used. Use {@link #SubtenantPolicyGroupListOptions()} instead.
     * 
     * @param subtenantPolicyGroupListOptions
     *            a subtenant policy group list options.
     */
    @Internal
    public SubtenantPolicyGroupListOptions(SubtenantPolicyGroupListOptions subtenantPolicyGroupListOptions) {
        this();
        setOptions(subtenantPolicyGroupListOptions);
    }
    ...
    public String toString() {
        return "SubtenantPolicyGroupListOptions [pageSize=" + pageSize + ", maxResults=" + maxResults + ", order="
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SubtenantPolicyGroupListOptions;
    }
     ...
     */
    @Override
    public SubtenantPolicyGroupListOptions clone() {
        final SubtenantPolicyGroupListOptions opt = new SubtenantPolicyGroupListOptions();
        opt.setOptions(this);
        return opt;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SubtenantPolicyGroupListOptions)) {
            return false;
        }
        final SubtenantPolicyGroupListOptions other = (SubtenantPolicyGroupListOptions) obj;
