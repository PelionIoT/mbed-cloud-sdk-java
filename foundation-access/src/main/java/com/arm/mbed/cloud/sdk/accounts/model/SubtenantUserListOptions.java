...
public class SubtenantUserListOptions extends ListOptions {
     ...
     */
    @Internal
    public SubtenantUserListOptions(Integer pageSize, Long maxResults, Order order, String after,
     ...
     * Note: Should not be used. Use {@link #SubtenantUserListOptions()} instead.
     * 
     * @param subtenantUserListOptions
     *            a subtenant user list options.
     */
    @Internal
    public SubtenantUserListOptions(SubtenantUserListOptions subtenantUserListOptions) {
        this();
        setOptions(subtenantUserListOptions);
    }
     ...
     *            filter value.
     */
    public void addEqualToStatusFilter(SubtenantUserStatus filterByStatus) {
     ...
     */
    @SuppressWarnings("unchecked")
    public <T extends SubtenantUserListOptions> T equalToStatus(SubtenantUserStatus filterByStatus) {
     ...
     *            filter value.
     */
    public void addInStatusesFilter(List<SubtenantUserStatus> filterByStatus) {
        addInFilter(TAG_FILTER_BY_STATUS, filterByStatus);
    }
     ...
     *            filter value.
     */
    public void addInStatusesFilter(SubtenantUserStatus... filterByStatus) {
        addInFilter(TAG_FILTER_BY_STATUS, filterByStatus);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public <T extends SubtenantUserListOptions> T inStatuses(String filterByStatus) {
     ...
     */
    @SuppressWarnings("unchecked")
    public <T extends SubtenantUserListOptions> T inStatuses(List<SubtenantUserStatus> filterByStatus) {
        addInStatusesFilter(filterByStatus);
        return (T) this;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public <T extends SubtenantUserListOptions> T inStatuses(SubtenantUserStatus... filterByStatus) {
        addInStatusesFilter(filterByStatus);
        return (T) this;
    }
     ...
     *            filter value.
     */
    public void addNotInStatusesFilter(List<SubtenantUserStatus> filterByStatus) {
        addNotInFilter(TAG_FILTER_BY_STATUS, filterByStatus);
    }
     ...
     *            filter value.
     */
    public void addNotInStatusesFilter(SubtenantUserStatus... filterByStatus) {
        addNotInFilter(TAG_FILTER_BY_STATUS, filterByStatus);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public <T extends SubtenantUserListOptions> T notInStatuses(String filterByStatus) {
     ...
     */
    @SuppressWarnings("unchecked")
    public <T extends SubtenantUserListOptions> T notInStatuses(List<SubtenantUserStatus> filterByStatus) {
        addNotInStatusesFilter(filterByStatus);
        return (T) this;
    }
    ...
    public String toString() {
        return "SubtenantUserListOptions [pageSize=" + pageSize + ", maxResults=" + maxResults + ", order=" + order
               + ", after=" + after + ", include="
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SubtenantUserListOptions;
    }
     ...
     */
    @Override
    public SubtenantUserListOptions clone() {
        final SubtenantUserListOptions opt = new SubtenantUserListOptions();
        opt.setOptions(this);
        return opt;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SubtenantUserListOptions)) {
            return false;
        }
        final SubtenantUserListOptions other = (SubtenantUserListOptions) obj;
