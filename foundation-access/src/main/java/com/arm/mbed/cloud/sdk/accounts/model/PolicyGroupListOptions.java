...
/**
 * Options to use when listing policy groups.
 * <p>
 * Note:
 * <ul>
 * <li>Filters:
 * <p>
 * The list can be filtered server-side on some of the fields of a policy group.
 * <p>
 ...
 * </ul>
 */
@Preamble(description = "Options to use when listing policy groups.")
@SuppressWarnings("PMD.AvoidDuplicateLiterals")
public class PolicyGroupListOptions extends ListOptions {
    /**
     ...
     * <p>
     * Note: Should not be used. Use {@link #PolicyGroupListOptions()} instead.
     * 
     * @param pageSize
     *            value.
     * @param maxResults
     ...
     */
    @Internal
    public PolicyGroupListOptions(Integer pageSize, Long maxResults, Order order, String after,
     ...
     * Note: Should not be used. Use {@link #PolicyGroupListOptions()} instead.
     * 
     * @param policyGroupListOptions
     *            a policy group list options.
     */
    @Internal
    public PolicyGroupListOptions(PolicyGroupListOptions policyGroupListOptions) {
        this();
        setOptions(policyGroupListOptions);
    }
     ...
     */
    @Internal
    public PolicyGroupListOptions(String after, List<IncludeField> include, Filters filter) {
    ...
    public String toString() {
        return "PolicyGroupListOptions [pageSize=" + pageSize + ", maxResults=" + maxResults + ", order=" + order
               + ", after=" + after + ", include="
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PolicyGroupListOptions;
    }
     ...
     */
    @Override
    public PolicyGroupListOptions clone() {
        final PolicyGroupListOptions opt = new PolicyGroupListOptions();
        opt.setOptions(this);
        return opt;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof PolicyGroupListOptions)) {
            return false;
        }
        final PolicyGroupListOptions other = (PolicyGroupListOptions) obj;
