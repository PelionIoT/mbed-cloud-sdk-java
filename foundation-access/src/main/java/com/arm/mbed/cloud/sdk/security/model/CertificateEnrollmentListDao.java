...
public class CertificateEnrollmentListDao extends AbstractCertificateEnrollmentListDao {
     ...
     * <p>
     * Similar to
     * {@link com.arm.mbed.cloud.sdk.Security#listCertificateEnrollments(String, String, String, String, String, String, java.util.Date, java.util.Date, java.util.Date, java.util.Date, com.arm.mbed.cloud.sdk.security.model.CertificateEnrollmentListOptions)}
     * 
     * @param options
     *            list options.
    ...
    protected ListResponse<CertificateEnrollment>
        ...
        /*
         * return ((Security)getModuleOrThrow()).listCertificateEnrollments(null, null, null, null, null, null, null,
