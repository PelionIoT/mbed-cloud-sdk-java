...
/**
 * Options to use when listing subtenant light theme images.
 * <p>
 * Note:
 * <ul>
 * <li>Filters:
 * <p>
 * The list can be filtered server-side on some of the fields of a subtenant light theme image.
 * <p>
 ...
 * </ul>
 */
@Preamble(description = "Options to use when listing subtenant light theme images.")
@SuppressWarnings("PMD.AvoidDuplicateLiterals")
public class SubtenantLightThemeImageListOptions extends ListOptions {
    /**
     ...
     * <p>
     * Note: Should not be used. Use {@link #SubtenantLightThemeImageListOptions()} instead.
     * 
     * @param pageSize
     *            value.
     * @param maxResults
     ...
     */
    @Internal
    public SubtenantLightThemeImageListOptions(Integer pageSize, Long maxResults, Order order, String after,
     ...
     * Note: Should not be used. Use {@link #SubtenantLightThemeImageListOptions()} instead.
     * 
     * @param subtenantLightThemeImageListOptions
     *            a subtenant light theme image list options.
     */
    @Internal
    public SubtenantLightThemeImageListOptions(SubtenantLightThemeImageListOptions subtenantLightThemeImageListOptions) {
        this();
        setOptions(subtenantLightThemeImageListOptions);
    }

    /**
     * Constructor.
     */
    public SubtenantLightThemeImageListOptions() {
        super();
        setDefault();
    }
     ...
     */
    @Internal
    public SubtenantLightThemeImageListOptions(String after, List<IncludeField> include, Filters filter) {
    ...
    public String toString() {
        return "SubtenantLightThemeImageListOptions [pageSize=" + pageSize + ", maxResults=" + maxResults + ", order="
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SubtenantLightThemeImageListOptions;
    }
     ...
     */
    @Override
    public SubtenantLightThemeImageListOptions clone() {
        final SubtenantLightThemeImageListOptions opt = new SubtenantLightThemeImageListOptions();
        opt.setOptions(this);
        return opt;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SubtenantLightThemeImageListOptions)) {
            return false;
        }
        final SubtenantLightThemeImageListOptions other = (SubtenantLightThemeImageListOptions) obj;
