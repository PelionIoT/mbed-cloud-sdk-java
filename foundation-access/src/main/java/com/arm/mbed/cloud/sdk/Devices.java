                                        ...
                                        return endpoints.getDefaultApi()
                                                        .groupList(finalOptions.getPageSize(),
                                                                   ...
                                                                   ListOptionsEncoder.encodeSingleNotInFilter(DeviceGroupListOptions.TAG_FILTER_BY_NAME,
                                                                                                              finalOptions),
                                                                   ListOptionsEncoder.encodeSingleEqualFilter(DeviceGroupListOptions.TAG_FILTER_BY_CUSTOM_ATTRIBUTES,
                                                                                                              finalOptions),
                                                                   ListOptionsEncoder.encodeSingleNotEqualFilter(DeviceGroupListOptions.TAG_FILTER_BY_CUSTOM_ATTRIBUTES,
                                                                                                                 finalOptions),
