...
/**
 * Options to use when listing light theme colors.
 * <p>
 * Note:
 * <ul>
 * <li>Filters:
 * <p>
 * The list can be filtered server-side on some of the fields of a light theme color.
 * <p>
 ...
 * </ul>
 */
@Preamble(description = "Options to use when listing light theme colors.")
@SuppressWarnings("PMD.AvoidDuplicateLiterals")
public class LightThemeColorListOptions extends ListOptions {
    /**
     ...
     * <p>
     * Note: Should not be used. Use {@link #LightThemeColorListOptions()} instead.
     * 
     * @param pageSize
     *            value.
     * @param maxResults
     ...
     */
    @Internal
    public LightThemeColorListOptions(Integer pageSize, Long maxResults, Order order, String after,
     ...
     * Note: Should not be used. Use {@link #LightThemeColorListOptions()} instead.
     * 
     * @param lightThemeColorListOptions
     *            a light theme color list options.
     */
    @Internal
    public LightThemeColorListOptions(LightThemeColorListOptions lightThemeColorListOptions) {
        this();
        setOptions(lightThemeColorListOptions);
    }

    /**
     * Constructor.
     */
    public LightThemeColorListOptions() {
        super();
        setDefault();
    }
     ...
     */
    @Internal
    public LightThemeColorListOptions(String after, List<IncludeField> include, Filters filter) {
    ...
    public String toString() {
        return "LightThemeColorListOptions [pageSize=" + pageSize + ", maxResults=" + maxResults + ", order=" + order
               + ", after=" + after + ", include="
    ...
    protected boolean canEqual(Object other) {
        return other instanceof LightThemeColorListOptions;
    }
     ...
     */
    @Override
    public LightThemeColorListOptions clone() {
        final LightThemeColorListOptions opt = new LightThemeColorListOptions();
        opt.setOptions(this);
        return opt;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof LightThemeColorListOptions)) {
            return false;
        }
        final LightThemeColorListOptions other = (LightThemeColorListOptions) obj;
