...
public class DeviceEnrollmentBulkCreateDao extends AbstractDeviceEnrollmentBulkCreateDao {
     ...
     *             if an error occurs during the process.
     */
    public DeviceEnrollmentBulkCreateDao(ApiClientWrapper client) throws MbedCloudException {
        super(client);
    }
     ...
     *             if an error occurs during the process.
     */
    public DeviceEnrollmentBulkCreateDao(ConnectionOptions options) throws MbedCloudException {
        super(options);
    }
     ...
     *             if an error occurs during the process.
     */
    public DeviceEnrollmentBulkCreateDao(SdkContext sdkContext) throws MbedCloudException {
        super(sdkContext);
    }
