...
/**
 * Options to use when listing subtenant api keys.
 * <p>
 * Note:
 * <ul>
 * <li>Filters:
 * <p>
 * The list can be filtered server-side on some of the fields of a subtenant api key.
 * <p>
 ...
 * </ul>
 */
@Preamble(description = "Options to use when listing subtenant api keys.")
@SuppressWarnings("PMD.AvoidDuplicateLiterals")
public class SubtenantApiKeyListOptions extends ListOptions {
    /**
     ...
     * <p>
     * Note: Should not be used. Use {@link #SubtenantApiKeyListOptions()} instead.
     * 
     * @param pageSize
     *            value.
     * @param maxResults
     ...
     */
    @Internal
    public SubtenantApiKeyListOptions(Integer pageSize, Long maxResults, Order order, String after,
     ...
     * Note: Should not be used. Use {@link #SubtenantApiKeyListOptions()} instead.
     * 
     * @param subtenantApiKeyListOptions
     *            a subtenant api key list options.
     */
    @Internal
    public SubtenantApiKeyListOptions(SubtenantApiKeyListOptions subtenantApiKeyListOptions) {
        this();
        setOptions(subtenantApiKeyListOptions);
    }
     ...
     */
    @Internal
    public SubtenantApiKeyListOptions(String after, List<IncludeField> include, Filters filter) {
     ...
     *
     * <p>
     * Similar to {@link com.arm.mbed.cloud.sdk.accounts.model.SubtenantApiKeyListOptions#addEqualToOwnerFilter(String)}
     * 
     * @param filterByOwner
     *            filter value.
     * @param <T>
     *            type of a subtenant api key list options
     * @return These list options
     */
    @SuppressWarnings("unchecked")
    public <T extends SubtenantApiKeyListOptions> T equalToOwner(String filterByOwner) {
     ...
     *
     * <p>
     * Similar to {@link com.arm.mbed.cloud.sdk.accounts.model.SubtenantApiKeyListOptions#addEqualToKeyFilter(String)}
     * 
     * @param filterByKey
     *            filter value.
     * @param <T>
     ...
     */
    @SuppressWarnings("unchecked")
    public <T extends SubtenantApiKeyListOptions> T equalToKey(String filterByKey) {
    ...
    public String toString() {
        return "SubtenantApiKeyListOptions [pageSize=" + pageSize + ", maxResults=" + maxResults + ", order=" + order
               + ", after=" + after + ", include="
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SubtenantApiKeyListOptions;
    }
     ...
     */
    @Override
    public SubtenantApiKeyListOptions clone() {
        final SubtenantApiKeyListOptions opt = new SubtenantApiKeyListOptions();
        opt.setOptions(this);
        return opt;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SubtenantApiKeyListOptions)) {
            return false;
        }
        final SubtenantApiKeyListOptions other = (SubtenantApiKeyListOptions) obj;
