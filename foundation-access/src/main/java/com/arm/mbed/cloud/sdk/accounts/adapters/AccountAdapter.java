...
public final class AccountAdapter {
    ...
    /**
     * Maps an account creation resp into an account.
     * 
     * @param toBeMapped
     *            an account creation resp.
     * @return mapped an account
     */
    @Internal
    public static Account map(AccountCreationResp toBeMapped) {
        if (toBeMapped == null) {
            return null;
        }
        final Account account = new Account(toBeMapped.getAdminId(), toBeMapped.getAdminKey(),
                                            BusinessModelHistoryAdapter.mapSimpleList(toBeMapped.getBusinessModelHistory()),
                                            TranslationUtils.toDate(toBeMapped.getCreatedAt()),
                                            TranslationUtils.toDate(toBeMapped.getExpiration()),
                                            AccountLimitationAdapter.mapSimpleList(toBeMapped.getLimitations()),
                                            ...
                                            TierHistoryAdapter.mapSimpleList(toBeMapped.getTierHistory()),
    ...
    public static Account map(AccountInfo toBeMapped) {
        ...
        final Account account = new Account(null, null,
                                            BusinessModelHistoryAdapter.mapSimpleList(toBeMapped.getBusinessModelHistory()),
                                            TranslationUtils.toDate(toBeMapped.getCreatedAt()),
                                            TranslationUtils.toDate(toBeMapped.getExpiration()),
                                            AccountLimitationAdapter.mapSimpleList(toBeMapped.getLimitations()),
                                            ...
                                            PolicyAdapter.mapSimpleList(toBeMapped.getPolicies()),
                                            toBeMapped.getReason(), toBeMapped.getReferenceNote(),
                                            translateInfoStatusToAccountStatus(toBeMapped.getStatus()),
                                            toBeMapped.getTemplateId(), toBeMapped.getTier(),
                                            TierHistoryAdapter.mapSimpleList(toBeMapped.getTierHistory()),
                                            TranslationUtils.toDate(toBeMapped.getUpdatedAt()),
                                            TranslationUtils.toDate(toBeMapped.getUpgradedAt()));
     ...
     */
    @Internal
    public static GenericAdapter.Mapper<AccountCreationResp, Account> getMapper() {
        return new GenericAdapter.Mapper<AccountCreationResp, Account>() {
            /**
             * Maps.
             * 
             * @param toBeMapped
             ...
             */
            @Override
            public Account map(AccountCreationResp toBeMapped) {
     ...
     */
    @Internal
    public static GenericAdapter.Mapper<AccountInfo, Account> getAccountInfoMapper() {
    ...
    public static ListResponse<Account> mapList(AccountInfoList toBeMapped) {
        ...
        return GenericAdapter.mapList(respList, AccountAdapter.getAccountInfoMapper());
    }
     ...
     */
    @Internal
    protected static AccountMfaStatus translateToAccountMfaStatus(AccountCreationResp.MfaStatusEnum toBeMapped) {
        if (toBeMapped == null) {
     ...
     */
    @Internal
    protected static AccountStatus translateToAccountStatus(AccountCreationResp.StatusEnum toBeMapped) {
        if (toBeMapped == null) {
     ...
     */
    @Internal
    protected static AccountStatus translateInfoStatusToAccountStatus(AccountInfo.StatusEnum toBeMapped) {
        if (toBeMapped == null) {
            return AccountStatus.getUnknownEnum();
        }
        switch (toBeMapped) {
