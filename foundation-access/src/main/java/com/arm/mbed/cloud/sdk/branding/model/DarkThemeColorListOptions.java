...
/**
 * Options to use when listing dark theme colors.
 * <p>
 * Note:
 * <ul>
 * <li>Filters:
 * <p>
 * The list can be filtered server-side on some of the fields of a dark theme color.
 * <p>
 ...
 * </ul>
 */
@Preamble(description = "Options to use when listing dark theme colors.")
@SuppressWarnings("PMD.AvoidDuplicateLiterals")
public class DarkThemeColorListOptions extends ListOptions {
    /**
     ...
     * <p>
     * Note: Should not be used. Use {@link #DarkThemeColorListOptions()} instead.
     * 
     * @param pageSize
     *            value.
     * @param maxResults
     ...
     */
    @Internal
    public DarkThemeColorListOptions(Integer pageSize, Long maxResults, Order order, String after,
     ...
     * Note: Should not be used. Use {@link #DarkThemeColorListOptions()} instead.
     * 
     * @param darkThemeColorListOptions
     *            a dark theme color list options.
     */
    @Internal
    public DarkThemeColorListOptions(DarkThemeColorListOptions darkThemeColorListOptions) {
        this();
        setOptions(darkThemeColorListOptions);
    }

    /**
     * Constructor.
     */
    public DarkThemeColorListOptions() {
        super();
        setDefault();
    }
     ...
     */
    @Internal
    public DarkThemeColorListOptions(String after, List<IncludeField> include, Filters filter) {
    ...
    public String toString() {
        return "DarkThemeColorListOptions [pageSize=" + pageSize + ", maxResults=" + maxResults + ", order=" + order
               + ", after=" + after + ", include="
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DarkThemeColorListOptions;
    }
     ...
     */
    @Override
    public DarkThemeColorListOptions clone() {
        final DarkThemeColorListOptions opt = new DarkThemeColorListOptions();
        opt.setOptions(this);
        return opt;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof DarkThemeColorListOptions)) {
            return false;
        }
        final DarkThemeColorListOptions other = (DarkThemeColorListOptions) obj;
