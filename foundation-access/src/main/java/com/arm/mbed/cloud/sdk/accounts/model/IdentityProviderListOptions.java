...
/**
 * Options to use when listing identity providers.
 * <p>
 * Note:
 * <ul>
 * <li>Filters:
 * <p>
 * The list can be filtered server-side on some of the fields of an identity provider.
 * <p>
 ...
 * </ul>
 */
@Preamble(description = "Options to use when listing identity providers.")
@SuppressWarnings("PMD.AvoidDuplicateLiterals")
public class IdentityProviderListOptions extends ListOptions {
    /**
     ...
     * <p>
     * Note: Should not be used. Use {@link #IdentityProviderListOptions()} instead.
     * 
     * @param pageSize
     *            value.
     * @param maxResults
     ...
     */
    @Internal
    public IdentityProviderListOptions(Integer pageSize, Long maxResults, Order order, String after,
     ...
     * Note: Should not be used. Use {@link #IdentityProviderListOptions()} instead.
     * 
     * @param identityProviderListOptions
     *            an identity provider list options.
     */
    @Internal
    public IdentityProviderListOptions(IdentityProviderListOptions identityProviderListOptions) {
        this();
        setOptions(identityProviderListOptions);
    }

    /**
     * Constructor.
     */
    public IdentityProviderListOptions() {
        super();
        setDefault();
    }
     ...
     */
    @Internal
    public IdentityProviderListOptions(String after, Filters filter) {
    ...
    public String toString() {
        return "IdentityProviderListOptions [pageSize=" + pageSize + ", maxResults=" + maxResults + ", order=" + order
               + ", after=" + after + ", include="
    ...
    protected boolean canEqual(Object other) {
        return other instanceof IdentityProviderListOptions;
    }
     ...
     */
    @Override
    public IdentityProviderListOptions clone() {
        final IdentityProviderListOptions opt = new IdentityProviderListOptions();
        opt.setOptions(this);
        return opt;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof IdentityProviderListOptions)) {
            return false;
        }
        final IdentityProviderListOptions other = (IdentityProviderListOptions) obj;
