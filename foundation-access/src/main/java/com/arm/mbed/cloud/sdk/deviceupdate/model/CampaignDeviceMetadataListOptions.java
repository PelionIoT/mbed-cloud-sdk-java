 ...
 * <li>Filters:
 * <p>
 * The list can be filtered server-side on some of the fields of a campaign device metadata.
 * <p>
...
public class CampaignDeviceMetadataListOptions extends ListOptions {
     ...
     * <p>
     * Note: Should not be used. Use {@link #CampaignDeviceMetadataListOptions()} instead.
     * 
     * @param pageSize
     *            value.
     * @param maxResults
     ...
     */
    @Internal
    public CampaignDeviceMetadataListOptions(Integer pageSize, Long maxResults, Order order, String after,
     ...
     * Note: Should not be used. Use {@link #CampaignDeviceMetadataListOptions()} instead.
     * 
     * @param campaignDeviceMetadataListOptions
     *            a campaign device metadata list options.
     */
    @Internal
    public CampaignDeviceMetadataListOptions(CampaignDeviceMetadataListOptions campaignDeviceMetadataListOptions) {
        this();
        setOptions(campaignDeviceMetadataListOptions);
    }

    /**
     * Constructor.
     */
    public CampaignDeviceMetadataListOptions() {
        super();
        setDefault();
    }
     ...
     */
    @Internal
    public CampaignDeviceMetadataListOptions(String after, List<IncludeField> include, Filters filter) {
    ...
    public String toString() {
        return "CampaignDeviceMetadataListOptions [pageSize=" + pageSize + ", maxResults=" + maxResults + ", order="
    ...
    protected boolean canEqual(Object other) {
        return other instanceof CampaignDeviceMetadataListOptions;
    }
     ...
     */
    @Override
    public CampaignDeviceMetadataListOptions clone() {
        final CampaignDeviceMetadataListOptions opt = new CampaignDeviceMetadataListOptions();
        opt.setOptions(this);
        return opt;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CampaignDeviceMetadataListOptions)) {
            return false;
        }
        final CampaignDeviceMetadataListOptions other = (CampaignDeviceMetadataListOptions) obj;
