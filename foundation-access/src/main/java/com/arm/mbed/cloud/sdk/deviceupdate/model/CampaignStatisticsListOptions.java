...
/**
 * Options to use when listing campaign statistics.
 * <p>
 * Note:
 * <ul>
 * <li>Filters:
 * <p>
 * The list can be filtered server-side on some of the fields of a campaign statistics.
 * <p>
 ...
 * </ul>
 */
@Preamble(description = "Options to use when listing campaign statistics.")
@SuppressWarnings("PMD.AvoidDuplicateLiterals")
public class CampaignStatisticsListOptions extends ListOptions {
    /**
     ...
     * <p>
     * Note: Should not be used. Use {@link #CampaignStatisticsListOptions()} instead.
     * 
     * @param pageSize
     *            value.
     * @param maxResults
     ...
     */
    @Internal
    public CampaignStatisticsListOptions(Integer pageSize, Long maxResults, Order order, String after,
     ...
     * Note: Should not be used. Use {@link #CampaignStatisticsListOptions()} instead.
     * 
     * @param campaignStatisticsListOptions
     *            a campaign statistics list options.
     */
    @Internal
    public CampaignStatisticsListOptions(CampaignStatisticsListOptions campaignStatisticsListOptions) {
        this();
        setOptions(campaignStatisticsListOptions);
    }

    /**
     * Constructor.
     */
    public CampaignStatisticsListOptions() {
        super();
        setDefault();
    }
     ...
     */
    @Internal
    public CampaignStatisticsListOptions(String after, List<IncludeField> include, Filters filter) {
    ...
    public String toString() {
        return "CampaignStatisticsListOptions [pageSize=" + pageSize + ", maxResults=" + maxResults + ", order=" + order
               + ", after=" + after + ", include="
    ...
    protected boolean canEqual(Object other) {
        return other instanceof CampaignStatisticsListOptions;
    }
     ...
     */
    @Override
    public CampaignStatisticsListOptions clone() {
        final CampaignStatisticsListOptions opt = new CampaignStatisticsListOptions();
        opt.setOptions(this);
        return opt;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CampaignStatisticsListOptions)) {
            return false;
        }
        final CampaignStatisticsListOptions other = (CampaignStatisticsListOptions) obj;
