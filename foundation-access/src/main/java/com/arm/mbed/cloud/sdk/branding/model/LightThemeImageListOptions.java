...
/**
 * Options to use when listing light theme images.
 * <p>
 * Note:
 * <ul>
 * <li>Filters:
 * <p>
 * The list can be filtered server-side on some of the fields of a light theme image.
 * <p>
 ...
 * </ul>
 */
@Preamble(description = "Options to use when listing light theme images.")
@SuppressWarnings("PMD.AvoidDuplicateLiterals")
public class LightThemeImageListOptions extends ListOptions {
    /**
     ...
     * <p>
     * Note: Should not be used. Use {@link #LightThemeImageListOptions()} instead.
     * 
     * @param pageSize
     *            value.
     * @param maxResults
     ...
     */
    @Internal
    public LightThemeImageListOptions(Integer pageSize, Long maxResults, Order order, String after,
     ...
     * Note: Should not be used. Use {@link #LightThemeImageListOptions()} instead.
     * 
     * @param lightThemeImageListOptions
     *            a light theme image list options.
     */
    @Internal
    public LightThemeImageListOptions(LightThemeImageListOptions lightThemeImageListOptions) {
        this();
        setOptions(lightThemeImageListOptions);
    }

    /**
     * Constructor.
     */
    public LightThemeImageListOptions() {
        super();
        setDefault();
    }
     ...
     */
    @Internal
    public LightThemeImageListOptions(String after, List<IncludeField> include, Filters filter) {
    ...
    public String toString() {
        return "LightThemeImageListOptions [pageSize=" + pageSize + ", maxResults=" + maxResults + ", order=" + order
               + ", after=" + after + ", include="
    ...
    protected boolean canEqual(Object other) {
        return other instanceof LightThemeImageListOptions;
    }
     ...
     */
    @Override
    public LightThemeImageListOptions clone() {
        final LightThemeImageListOptions opt = new LightThemeImageListOptions();
        opt.setOptions(this);
        return opt;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof LightThemeImageListOptions)) {
            return false;
        }
        final LightThemeImageListOptions other = (LightThemeImageListOptions) obj;
